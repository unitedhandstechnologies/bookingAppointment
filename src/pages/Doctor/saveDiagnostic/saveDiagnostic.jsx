...
class SaveDiagnostic extends React.Component {
  ...
  onUploadPrescribeMedicineDocs = (e) => {
    promiseWrapper(this.props.patientactions.uploadDocument, {
      documentType: 5,
      referenceGuid: this.props.match.params.appointmentGuid,
  ...
  onDeleteAdditionalDocumentText = (idx, e) => {
    ...
    $(
      "#" +
        this.state.DiagnosticDetails.additionalDocuments.length -
        1 +
        "addDoc"
    ).prop("disabled", false);
  };
  ...
  onSubmit = (e) => {
    let errorMessage = "";
    if (
      this.state.DiagnosticDetails.describeProblem === "" ||
      this.state.DiagnosticDetails.describeProblem === null
    ) {
      errorMessage += `Please Describe problem or symptoms. \n`;
    }

    if (
      this.state.DiagnosticDetails.diagnosticConclusion === "" ||
      this.state.DiagnosticDetails.diagnosticConclusion === null
    ) {
      errorMessage += `Please Enter Diagnostic Conclusion. \n`;
    }

    if (
      this.state.DiagnosticDetails.prescribeMedicine === "" ||
      this.state.DiagnosticDetails.prescribeMedicine === null
    ) {
    ...
    const additionalServiceData = this.state.addedAdditionalServices.length
      ? this.state.addedAdditionalServices.map((service) => {
          return {
    ...
    promiseWrapper(this.props.docactions.saveDiagnosticReport, {
      model: {
        ...
        totalConsultAmount:
          this.state.DiagnosticDetails.appDetail.consultFees +
      ...
      .then((data) => {
        if (data.isSuccess === true) {
          if (additionalServiceData) {
            promiseWrapper(this.props.docactions.saveAdditionalServices, {
              modal: { additionalServiceData },
            })
              .then((data2) => {
  ...
  addAdditionalServiceData = (servicesArray, totalFee) =>
    this.setState(
      { addedAdditionalServices: servicesArray, additionalFees: totalFee },
      () => console.log(servicesArray, totalFee, "new data")
    );
                    ...
                    <div className="col-md-10 col-lg-6 col-sm-12 col-12 m-auto">
                      <div className="appointment-details-form py-4">
                        <div className="appointment-details-form-title">
                          <h3>
                            {t(
                              "Doctor.SaveDiagnostic.Upload_diagnostic_report"
                            )}
                          </h3>
                        </div>
                        <div className="appointment-details-form-info my-4">
                          <div className="row">
                            <div className="col-md-8 col-sm-8 col-8">
                              ...
                              <div className="appointment-details-form-info-value">
                                {new Date(
                                  this.state.DiagnosticDetails.appDetail.appointmentDate
                                ).toDateString()}
                              </div>
                            </div>
                          ...
                          <div className="row mt-4">
                            <div className="col-md-4 col-sm-4 col-4">
                              ...
                              <div className="appointment-details-form-info-value">
                                {
                                  this.state.DiagnosticDetails.appDetail
                                    .patientName
                                }
                              </div>
                            </div>
                            ...
                            <div className="col-md-4 col-sm-4 col-4">
                              ...
                              <div className="appointment-details-form-info-value">
                                €{" "}
                                {this.state.DiagnosticDetails.appDetail
                                  .consultFees + this.state.additionalFees}
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="form-group">
                          <label htmlFor="describe-problem-textarea">
                            {t(
                              "Doctor.SaveDiagnostic.Describe_problem_or_symptoms."
                            )}
                          </label>
                          <textarea
                        ...
                        <div className="form-group my-4">
                          <label htmlFor="describe-problem-textarea">
                            {t("Doctor.SaveDiagnostic.Diagnostic_Conclusion")}
                          </label>
                          <textarea
                            className="form-control appointment-details-form-inputs"
                            id="describe-problem-textarea"
                            onChange={this.UpdateConclusionText.bind(this)}
                            rows="3"
                            placeholder={t("Doctor.SaveDiagnostic.Describe")}
                            value={
                              this.state.DiagnosticDetails
                        ...
                        <div className="form-group my-4">
                          <label htmlFor="symptoms-active">
                            {t("Doctor.SaveDiagnostic.Prescribe_Medication")}
                          </label>
                          <div className="d-flex">
                            <input
                              type="text"
                              onChange={this.UpdateMedicationText.bind(this)}
                              className="form-control appointment-details-form-inputs"
                              value={
                                this.state.DiagnosticDetails
                                  .prescribeMedicine || ""
                            ...
                            <label className="btn form-file-upload-btn btn-default mb-0 mx-1">
                              ...
                              <input
                                type="file"
                                hidden
                                onChange={this.onUploadPrescribeMedicineDocs.bind(
                                  this
                                )}
                              />
                            </label>
                          ...
                          {this.state.DiagnosticDetails
                            .prescribeMedicineDocs !== null &&
                            this.state.DiagnosticDetails.prescribeMedicineDocs
                              .length > 0 &&
                            this.state.DiagnosticDetails.prescribeMedicineDocs.map(
                              (v, idx) => (
                                <div className="col-md-12 col-6" key={idx}>
                                  ...
                                  <a
                                    ...
                                    onClick={this.onDeleteprescribeMedicineDocs.bind(
                                      this,
                                      v.docURL,
                                      v.docName,
                                      idx
                        ...
                        <div className="form-group my-4">
                          <label htmlFor="symptoms-active">
                            {t("Doctor.SaveDiagnostic.Additional_Documents")}
                          </label>
                          {this.state.DiagnosticDetails.additionalDocuments.map(
                            (d, idx) => (
                              <div key={idx}>
                                <div className="d-flex mt-3">
                                  <input
                                    type="text"
                                    onChange={this.UpdateAdditionalDocumentText.bind(
                                      this,
                                      idx
                                    )}
                                    className="form-control appointment-details-form-inputs"
                                    id="symptoms-active"
                                    placeholder={t(
                                      "Doctor.SaveDiagnostic.Describe"
                                    )}
                                  />
                                  <label className="btn form-file-upload-btn btn-default mb-0 mx-1">
                                    {t("Doctor.SaveDiagnostic.Upload")}
                                    {d.additionalFile.docURL !== null && (
                                      <input
                                        ...
                                        id={idx + "addDoc"}
                                        hidden
                                        onChange={this.onUploadAdditionalDocument.bind(
                                          this,
                                          idx
                                        )}
                                      />
                                  ...
                                  <div className="col-md-1 mt-2 d-flex justify-content-center align-items-start">
                                    <a
                                      ...
                                      style={{ cursor: "pointer" }}
                                      onClick={this.onDeleteAdditionalDocumentText.bind(
                                        this,
                                        idx
                                      )}
                                    >
                                ...
                                {d.additionalFile.docURL !== null && (
                                  <div className="col-md-12 col-6">
                                    <a
                                      href={d.additionalFile.docURL}
                                      target="_blank"
                                      className="attachment-links"
                                    >
                                      {d.additionalFile.docName}
                                    </a>
                                  </div>
                                )}
                              </div>
                          ...
                          <div className="d-flex justify-content-end add-new">
                            <a
                              onClick={this.onAddAdditionalDocuments.bind(this)}
                            >
                              {t("Doctor.SaveDiagnostic.+_Add_New")}{" "}
                            </a>
                          </div>
                        </div>
                        <AddAdditionalServices
                          addAdditionalServiceData={(servicesArray, totalFee) =>
                            this.addAdditionalServiceData(
                              servicesArray,
                              totalFee
                            )
                          }
                          ...
                          appointmentGuid={
                            this.props.match.params.appointmentGuid
                          }
                          t={t}
                        />
                        <div className="book-appointment-btn my-4 d-flex justify-content-around">
                          ...
                          <a
                            ...
                            role="button"
                          >
                            {t("Doctor.SaveDiagnostic.Submit")}
                          </a>
                        </div>
                      </div>
                    </div>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(SaveDiagnostic));
