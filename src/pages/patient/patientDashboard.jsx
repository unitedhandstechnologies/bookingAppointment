...
class PatientDashboard extends React.Component {
    ...
    GetAppointmentRequestList() {
        ...
        promiseWrapper(this.props.patientactions.getAppointments, { filter: param }).then((data) => {
            const filterArray = data.patientAppointments.filter(appointment => isAppointmentNew(appointment.appointmentDateTime))
    ...
    getUserLanguage = () => {
        promiseWrapper(this.props.patientactions.getPatientProfileInfo, { userGuid: localStorage.getItem(localStorageKeys.userId) }).then(data => {
            if (data.languageId) {
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-md-12 col-sm-12 col-lg-10 mainRightPanel mainRightPanel-background ">
                                <div className="mainRightPanelAlert d-flex align-items-center my-4" role="alert">
                                ...
                                <div className="row mt-3">
                                    <div className="col-lg-3 col-md-6 mb-3">
                                        <Link to="/patient-myfinance" className="card-links">
                                            <div className="card card1 mainRightPanelCard">
                                                <div className="p-3">
                                                    <div className="cardHeader">{t('Patient.Dashboard_My_Finances')}</div>
                                    ...
                                    <div className="col-lg-3 col-md-6 mb-3">
                                        <Link to="/book-an-appoinment" className="card-links">
                                            <div className="card card2 mainRightPanelCard">
                                                <div className="p-3">
                                                    <div className="cardHeader">{t('Patient.Dashboard_Consult_Doctor')}</div>
                                    ...
                                    <div className="col-lg-3 col-md-6 mb-3">
                                        <Link to="/emergency" className="card-links">
                                            <div className="card card1 mainRightPanelCard">
                                                <div className="p-3">
                                                    <div className="cardHeader">{t('Patient.Dashboard_Got_Emergency')}</div>
                                                    {/* <div className="card2Body">Book your appointment with your nearby Expert.</div>
                                                    <div className="cardFooter d-flex justify-content-between align-items-end">
                                                        <div className="footerLeft"></div>
                                                        <div className="footerRight">
                                    ...
                                    <div className="col-lg-3 col-md-6 mb-3">
                                        <Link to="/chat-with-doctor" className="card-links">
                                            <div className="card card1 mainRightPanelCard">
                                                <div className="p-3">
                                                    <div className="cardHeader">{t('Patient.Dashboard_Chat_With_Doctor')}</div>
                                    ...
                                    <div className="col-md-12 table-min-height">
                                        <div className="tableHeading d-flex justify-content-between mb-4">
                                            <div className="headingLeft">
                                                <div>{t('Patient.AppointmentUpComing.Upcoming_Requested_Appointments')}</div>
                                            </div>
                                            <div className="headingRight">
                                                <Link to="/patient-appointment-requests">{t('Patient.AppointmentUpComing.View_All')}</Link>
                                            </div>
                                        </div>
                                            ...
                                            <table className="table table-bordered appointmentTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th rowspan="2">{t('Patient.AppointmentUpComing.Status')}</th>
                                                    ...
                                                    <tbody>
                                                        {this.state.AppointmentRequestList.length > 0 ? this.state.AppointmentRequestList.map((v, idx) => (
                                                            <tr key={idx}>
                                                                ...
                                                                <td>
                                                                    <Link className="doctor-name-link" to={`/book-an-appoinment-doc-detail/${v.doctorGuid}`}>{v.doctorFirstName} {v.doctorLastName}</Link>
                                                                </td>
                                                            ...
                                                            <td colSpan={7} className="empty-list">{t("EmptyListMessages.upcoming_requested_list")}</td>
                                                        </tr>}
                                                    </tbody>
                                                }
                                            </table>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(PatientDashboard));