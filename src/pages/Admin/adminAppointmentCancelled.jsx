...
const AdminAppointmentCancelled = (props) => {
...
// class AdminAppointmentCancelled extends React.Component {
//     constructor(props) {
//         super(props);
//         this.state = {
//             LoadedData: false,
...
//                                                                 </tr>
//                                                             )) : <tr><td colSpan={9} className="empty-list">
//                                                             {t("EmptyListMessages.cancelled_appointments")}</td></tr>
//                                                             }
//                                                         </tbody>
//                                                     }
//                                                 </table>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(AdminAppointmentCancelled));
