...
// const AdminRefundPopup = (props) => {
//   const [AdminRefundReason, setAdminRefundReason] = useState("");
//   const [RefundPercentage, setRefundPercentage] = useState("");

//   const { t } = props;

//   const closeAdminRefundPopup = () => {
//     props.CloseAdminRefundPopup("", "", 0);
//   };

//   const UpdateRefundReason = (e) => {
//     setAdminRefundReason(e.target.value);
//   };

//   const UpdateRefundPercentage = (e) => {
//     setRefundPercentage(e.target.value);
//   };

//   const SaveRefund = () => {
//     let errorMessage = "";
//     if (AdminRefundReason === "") {
...
//     let aprefund = {
//       refundGuid: props.RefundDetails.RefundGuid,
//       appointmentGuid: props.RefundDetails.AppointmentGuid,
//       refundReason: props.RefundDetails.RefundReason,
//       refundAmount: props.RefundDetails.RefundAmount,
//       refundPercentage: Number(RefundPercentage),
//       adminReason: AdminRefundReason,
//     };
//     promiseWrapper(props.adminactions.approveRefund, { model: aprefund }).then(
//       (data) => {
...
class AdminRefundPopup extends React.Component {
    ...
    SaveRefund() {
        ...
        promiseWrapper(this.props.adminactions.approveRefund, { model: aprefund })
            .then((data) => {
                if (data.isSuccess == true) {
                    toast.success(data.message);
            ...
            <div className="modal modify-modal" style={{ display: "block" }} tabindex="-1" role="dialog">
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header modify-modal-header">
                            <h5 className="modal-title modify-modal-title">Approve Refund</h5>
                            <button type="button" className="close ms-0 model-close-btn" onClick={this.closeAdminRefundPopup}>
                        ...
                        <div className="modal-body modify-modal-body">
                            <div className="appointment-details">
                                <div className="row">
                                    <div className="mb-3">How much amount should be refunded?</div>
                                    <div className="search-bar-text-input mb-4">
                                        <div className="d-flex  justify-content-between divForm-radio mt-1">
                                            <div className="form-check">
                                                <div>
