...
import { FaColumns, FaCalendar, FaCommentAlt, FaUser, FaAmbulance, FaEuroSign, FaQuestionCircle, FaCog, FaEnvelopeOpenText } from 'react-icons/fa';
            ...
            <div className="col-md-12 col-lg-2 col-sm-12 mainLeftPanel p-0">
                ...
                <ProSidebar className="mobile-sidebar-toggle" onToggle={this.MobileToggleClick.bind(this)} toggled={this.state.LeftMenuToggled} breakPoint="md">
                    <SidebarContent>
                        ...
                        <Menu iconShape="circle">
                            <MenuItem icon={<FaUser />} active={false}>{t('Doctor.LeftPanel.MyPatients')}<Link to="/doctor-dashboard" /></MenuItem>
                        </Menu>
                        <Menu iconShape="circle">
                            <MenuItem icon={<FaAmbulance />} active={false}>{t('Doctor.LeftPanel.MyEmergencyCalls')}<Link to="/doctor-dashboard" /></MenuItem>
                        </Menu>
                        <Menu iconShape="circle">
                            <MenuItem icon={<FaEuroSign />} active={false}>{t('Doctor.LeftPanel.MyFinance')}<Link to="/doctor-dashboard" /></MenuItem>
                        </Menu>
                        <Menu iconShape="circle">
