export const GET_PATIENT_PROFILE_INFO = "api/GetPatientProfileInfo";
export const SAVE_PATIENT_PROFILE_INFO = "api/SavePatientProfileInfo";
export const DELETE_PATIENT = "api/DeletePatient";
export const CHANGE_STATUS = "api/ChangeStatus";
export const GET_PATIENT_QUESTIONNAIRE = "api/GetPatientQuestionnaire";
export const GET_PATIENT_ANSWERS = "api/GetPatientAnswers";
export const SAVE_ANSWERS = "api/SaveAnswers";
export const SEARCH_DOCTOR_APPOINTMENT = "api/SearchDoctorAppointment";
export const GET_LOCATION = "patient/location";
export const SEARCH_APPOINTMENT = "api/SearchAppointment";
export const GET_MORE_REVIEWS = "api/GetMoreReviews";
...
export const UPDATE_PATIENT_ATTACHMENT = "api/UpdatePatientAttachment";
export const GET_APPOINTMENTS = "api/GetAppointments";
...
export const GET_WALLET_BALANCE = "api/GetWalletBalance";
...
export const WITHDRAW_MONEY = "api/AddWithdraw";
export const GET_PATIENT_FINANCE_DATA = "api/GetPatientFinanceData";
