...
export class Finance extends Component {
  ...
  getPaymentData() {
    ...
    promiseWrapper(this.props.adminactions.getDoctorPayment, {
      query: param,
    }).then((data) => {
      this.setState({
        ...
        <div className="admin-doctor-title mb-2 p-0">
          <Form className="row" onSubmit={(e) => this.handleSubmit(e)}>
            ...
            <button type="submit" className="btn btn-success col">
              {t("Admin.DoctorDetailView.Finance.Get_Finance_Data")}
            </button>
          </Form>
        </div>
        <hr />
        <div className="col-lg-12 col-md-12">
          <div className="row">
            <div className="col-md-4 admin-doctor-name">
              {t("Admin.DoctorDetailView.Finance.Total_Amount")} :{" "}
            </div>
          ...
          <div className="row">
            <div className="col-md-4 admin-doctor-name">
              {t("Admin.DoctorDetailView.Finance.Total_Commission")} :{" "}
            </div>
            <div className="col-md-8">
              <div className="mb-2">
                <div className="d-flex admin-doctor-value">
          ...
          <div className="row">
            <div className="col-md-4 admin-doctor-name">
              {t("Admin.DoctorDetailView.Finance.Total_Refund")} :{" "}
            </div>
            <div className="col-md-8">
              <div className="mb-2">
                <div className="d-flex admin-doctor-value">
          ...
          <div className="row">
            <div className="col-md-4 admin-doctor-name">
              {t("Admin.DoctorDetailView.Finance.Total_Paid")} :{" "}
            </div>
            <div className="col-md-8">
              <div className="mb-2">
                <div className="d-flex admin-doctor-value">
