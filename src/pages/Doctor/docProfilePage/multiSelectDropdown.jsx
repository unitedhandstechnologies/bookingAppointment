...
class DropdownMultiselect extends React.Component {
    ...
    handleChange(ev) {
        ...
        if (this.props.handleOnChange !== undefined) this.props.handleOnChange(currentSelected)
    }
    ...
    handleSelectDeselectAll() {
        if (this.state.selected.length == this.state.options.length) {
            ...
            if (this.props.handleOnChange !== undefined) this.props.handleOnChange([])
        } else {
            ...
            if (this.props.handleOnChange !== undefined) this.props.handleOnChange(newSelected)
        }
    }
    render() {
        const dropdownClass =
