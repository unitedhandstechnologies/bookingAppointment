...
import { FaColumns, FaCalendar, FaUser, FaCog, FaEnvelopeOpenText } from 'react-icons/fa';
            ...
            <div className="col-md-12 col-lg-2 col-sm-12 mainLeftPanel p-0">
                <ProSidebar toggled={this.state.LeftMenuToggled} breakPoint="md">
                    <SidebarContent>
                        ...
                        <Menu iconShape="circle">
                            <MenuItem icon={<FaEnvelopeOpenText />} active={false}><Link to="/admin-dashboard" />CMS</MenuItem>
                        </Menu>
                        <Menu iconShape="circle">
