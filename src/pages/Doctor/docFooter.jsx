...
class DoctorFooter extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
                ...
                <div>
                    <div className="row bg-white">
                        ...
                        <div className="col-lg-12 div-footer-text py-3">
                            <span>{t('Doctor.DocFooter.copy_right')}</span>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(DoctorFooter));