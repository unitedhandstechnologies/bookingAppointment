                            ...
                            <div className="my-finance-section">
                                    ...
                                    <div className="row my-4">
                                        ...
                                        <div className="search-bar-text-input col-md-2">
                                            <button type="button"
                                                ...
                                                className="btn filter-btn w-100">{t('Doctor.AppointmentCompleted.Search')}</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="tableContainer table-responsive mb-5">
                                    <table className="table table-bordered appointmentTable">
                                        ...
                                        <tbody>
                                            {patientsList.length > 0 ? patientsList.map((list, i) =>
                                                <tr key={i}>
                                                    <td>{i + 1}</td>
                                                    <td>
                                                        <Link className="patientName"
                                                            to={"/patient-detail-view/" //+ list.patientGuid
                                                            }
                                                    ...
                                                    <td>
                                                        <Link
                                                            ...
                                                            onClick={e => e.preventDefault()}><FaEye /></Link>
                                                    </td>
                                                </tr>) : <tr><td colSpan={7} className="empty-list">{t("EmptyListMessages.patient_list")}</td></tr>}
                                        </tbody>
                                    </table>
