...
class AskRefundPopup extends React.Component {
  ...
  closeAskRefundPopup = () => {
    this.props.CloseAskRefundPopup(
      this.props.AppoinmentDetails.appointmentGuid
    );
  };
  ...
  SaveRefund() {
    ...
    promiseWrapper(this.props.patientactions.addRefund, {
      refundModel: refund,
    }).then((data) => {
          ...
          <div className="modal-content">
            <div className="modal-header modify-modal-header">
              ...
              <button
                ...
                onClick={this.closeAskRefundPopup}
              >
                ...
                <div className="row">
                  <div className="col-md-4">
                    <div className="appointment-details-container">
                      ...
                      <div className="appointment-details-text">
                        {new Date(
                          this.props.AppoinmentDetails.appointmentDateTime
                        ).toDateString()}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-4">
                    <div className="appointment-details-container">
                      ...
                      <div className="appointment-details-text">
                        {this.props.AppoinmentDetails.doctorFirstName}{" "}
                        {this.props.AppoinmentDetails.doctorLastName}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-4">
                    <div className="appointment-details-container">
                      ...
                      <div className="appointment-details-text">
                        <span>
                          {this.props.AppoinmentDetails.patientFirstName}{" "}
                          {this.props.AppoinmentDetails.patientLastName}
                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="appointment-details-container">
                      <div className="appointment-details-title">
                        {t("Patient.ViewDignosticReport.Booking_Id")}
                      </div>
                      <div className="appointment-details-text">
                        {this.props.AppoinmentDetails.bookingId}
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="appointment-details-container">
                      <div className="appointment-details-title">
                        {t("Patient.ViewDignosticReport.Consultation_Fees")}
                      </div>
                      <div className="appointment-details-text">
                        € {this.props.AppoinmentDetails.amount}
                      </div>
                    </div>
                  </div>
                </div>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(AskRefundPopup));
