                          ...
                          <div className="col-md-12 p-0">
                            ...
                            >
                              <li className="nav-item">
                                ...
                                >
                                  {t(
                                    "Patient.ViewDignosticReport.Patient_Symptoms"
                                  )}
                                </a>
                              </li>
                              <li className="nav-item">
                                ...
                                >
                                  {t(
                                    "Patient.ViewDignosticReport.Appointment_Details"
                                  )}
                                </a>
                              </li>
                            </ul>
                            <div className="tab-content" id="myTabContent">
                                  ...
                                  {this.state.DiagnosticDetails
                                    ...
                                    this.state.DiagnosticDetails
                                      ...
                                      <div className="my-2">
                                        <div className="patient-symptoms-question">
                                          {t(
                                            "Patient.ViewDignosticReport.Attachments"
                                          )}
                                        </div>
                                        <div className="patient-symptoms-answer">
                              ...
                              >
                                <div className="row">
                                  <div className="col-md-12 my-profile-column">
                                    <div className="my-profile-container d-flex align-items-center">
                                      ...
                                      <div className="mx-4 my-profile-details">
                                        ...
                                        <div className="my-profile-details-exp">
                                          ...
                                          {t(
                                            "Patient.ViewDignosticReport.Overall_Experience"
                                          )}
                                        </div>
                                      </div>
                                    </div>
                                    {this.state.viewAppointmentFeedBackPopup ? (
                                      <AppointmentFeedBack
                                        CloseAppointmentFeedBack={
                                          this.toggleAppointmentFeedBackPopUp
                                        }
                                        AppointmentData={
                                          this.state.DiagnosticDetails
                                            .appointmentData
                                    ...
                                    {this.state.DiagnosticDetails
                                      ...
                                      false &&
                                      this.state.DiagnosticDetails
                                        .appointmentData.feedbackPendingHours >
                                        0 && (
                                        <div className="text-center">
                                          <button
                                            className="btn doctor-dignostic-reprot-feedback-btn mt-3"
                                          ...
                                          >
                                            {t(
                                              "Patient.ViewDignosticReport.Feedback_Pending"
                                            )}
                                          </button>
                                          <div>
                                            {parseInt(
                                              this.state.DiagnosticDetails
                                                .appointmentData
                                                .feedbackPendingHours
                                            )}{" "}
                                            {t(
                                              "Patient.ViewDignosticReport.Hours_Pending"
                                            )}{" "}
                                          </div>
                                        </div>
                                      )}
                                      ...
                                      this.state.DiagnosticDetails
                                        ...
                                        <div>
                                          <button className="btn btn-secondary mt-3">
                                            {t(
                                              "Patient.ViewDignosticReport.Feedback_Expired"
                                            )}
                                          </button>
                                        </div>
                                      )}
                                    {this.state.DiagnosticDetails
                                      ...
                                      <div>
                                        <button className="btn btn-success mt-3">
                                          {t(
                                            "Patient.ViewDignosticReport.Feedback_Given"
                                          )}
                                        </button>
                                      </div>
                                    )}
                                ...
                                <div className="row mt-4">
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>
                                        {t("Patient.ViewDignosticReport.Date")}
                                      </span>
                                    </div>
                                  ...
                                  <div className="col-lg-2 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>
                                        {t("Patient.ViewDignosticReport.Time")}
                                      </span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                  ...
                                  <div className="col-lg-2 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>
                                        {t(
                                          "Patient.ViewDignosticReport.Patient_Details"
                                        )}
                                      </span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                  ...
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>
                                        {t(
                                          "Patient.ViewDignosticReport.Booking_Id"
                                        )}
                                      </span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                  ...
                                  <div className="col-lg-2 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>
                                        {t(
                                          "Patient.ViewDignosticReport.Consultation_Fees"
                                        )}
                                      </span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                ...
                                <div>
                                  <div className="doctor-report-title">
                                    <span className="doctor-report-title-text">
                                      {t(
                                        "Patient.ViewDignosticReport.Diagnostic_Report"
                                      )}
                                    </span>
                                  </div>
                                  <div className="my-3">
                                    <div className="admin-info-title d-flex align-items-center">
                                      ...
                                      <span>
                                        {t(
                                          "Patient.ViewDignosticReport.Describe_Problem"
                                        )}
                                      </span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                  ...
                                  <div className="mb-3">
                                    <div className="admin-info-title d-flex align-items-center">
                                      ...
                                      <span>
                                        {t(
                                          "Patient.ViewDignosticReport.Diagnostic_Conclusion"
                                        )}
                                      </span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                  ...
                                  <div className="mb-3">
                                    <div>
                                      <div className="admin-info-title d-flex align-items-center">
                                        ...
                                        <span>
                                          {t(
                                            "Patient.ViewDignosticReport.Prescribe_Medication"
                                          )}
                                        </span>
                                      </div>
                                      ...
                                      <div className="mb-3">
                                        <div>
                                          <div className="admin-info-title d-flex align-items-center">
                                            ...
                                            <span>
                                              {t(
                                                "Patient.ViewDignosticReport.Additional_Documents"
                                              )}
                                            </span>
                                          </div>
                                    ...
                                    <div className="doctor-details mt-4">
                                      <div className="admin-info-title d-flex align-items-center">
                                        <span className="admin-info-title-text">
                                          {t(
                                            "Patient.ViewDignosticReport.Feedback"
                                          )}
                                        </span>
                                      </div>
                                    </div>
                                ...
                                <div className="d-flex flex-column flex-md-row justify-content-between">
                                  {this.state.DiagnosticDetails
                                    .patientAppointmentDetail.isPaidOnline &&
                                    this.state.DiagnosticDetails
                                      .patientAppointmentDetail
                                    ...
                                    this.state.DiagnosticDetails
                                      ...
                                      <div className="mb-2 text-left text-md-center">
                                        <button
                                          className=" btn doctor-dignostic-reprot-feedback-btn"
                                          onClick={this.ShowRefundPopUp.bind(
                                            this
                                          )}
                                        >
                                          {t(
                                            "Patient.ViewDignosticReport.Ask_for_refund"
                                          )}
                                        </button>
                                        <div className="mx-2">
                                          {parseInt(
                                    ...
                                    this.state.DiagnosticDetails
                                      ...
                                      <div className="mb-2 text-left text-md-center">
                                        <a className="dropdown-item">
                                          {t(
                                            "Patient.ViewDignosticReport.Refund_time_left"
                                          )}
                                        </a>
                                      </div>
                                    )}
                                  {this.state.DiagnosticDetails
                                    ...
                                    this.state.DiagnosticDetails
                                      ...
                                      <div className="mb-2 text-left text-md-center">
                                        <a className="dropdown-item">
                                          {t(
                                            "Patient.ViewDignosticReport.Applyed_for_Refund"
                                          )}
                                        </a>
                                      </div>
                                    )}
                                    ...
                                    this.state.DiagnosticDetails
                                      ...
                                      <div className="mb-2 text-left text-md-center">
                                        <a className="dropdown-item">
                                          ...
                                          (€){" "}
                                          {t(
                                            "Patient.ViewDignosticReport.Refunded"
                                          )}{" "}
                                        </a>
                                      </div>
                                    )}
                                  ...
                                  <div className="mb-2">
                                    <button className=" btn doctor-dignostic-reprot-feedback-btn ">
                                      {t(
                                        "Patient.ViewDignosticReport.Invoice_receipt"
                                      )}
                                    </button>
                                  </div>
                                  <div>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(PatientViewDignosticReport));
