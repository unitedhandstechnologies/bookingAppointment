...
const Controls = (props) => {
   ...
   const changeTrackSetting = async (type) => {
      if (type === "a") {
         ...
         setTrackState(prev => { return { ...prev, audio: !prev.audio } })
      }
      else if (type === "v") {
         await props.tracks[1].setEnabled(!trackState.video)
         setTrackState(prev => { return { ...prev, video: !prev.video } })
      }
   }
   ...
   const setClick = async () => {
      ...
      else if (userMode === userType.patient) props.push("/patient-appointment-upcoming")
   }

   const MarkAppointmentAsCompleteWithDiagnostic = () => {
      promiseWrapper(props.docactions.markAppointmentAsComplete, { appointmentGuid: props.appointmentGuid })
         .then((data) => {
            ...
            <div className="row">
               ...
               <div className="col-4">
                  <div className="d-flex justify-content-center">
                     ...
                     >
                        {!trackState.audio && "no"}<img src="assets/images/Micemute.png" alt="Micemute.png" className="img-fluid w-50" />
                     </div>
                     <div
                     ...
                     >
                        {!trackState.video && "no"}<img src="assets/images/VideoCall.png" alt="VideoCall.png" className="img-fluid w-50" />
                     </div>
                     <div className="icon-container rounded-circle d-flex justify-content-center align-items-center"
                        onClick={() => setConfirmModal(true)}
                     >
                        <img src="assets/images/Callend.png" alt="Callend.png" className="img-fluid w-50" />
                     </div>
                     {!props.start &&
                        <button
               ...
               <div className="col-4">
                  <div className="d-flex justify-content-end">
                     <div className="icon-container rounded-circle d-flex justify-content-center align-items-center">
                        <img src="assets/images/Record.png" alt="Record.png" className="img-fluid w-50" />
                     </div>
                     <div className="icon-container rounded-circle d-flex justify-content-center align-items-center ms-2" onClick={() => props.setShowSidebar(!props.showSidebar)}>
