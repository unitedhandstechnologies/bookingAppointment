import {
    GET_PATIENT_PROFILE_INFO, SAVE_PATIENT_PROFILE_INFO, CHANGE_STATUS, DELETE_PATIENT,
    ...
    UPDATE_APPOINTMENT_MODEL, UPDATE_DOCTOR_APPOINTMENT_DETAILS,
...
const searchDoctorAppointment = ({ appointmentModel, doctorGuid, promise }) => (
    {
...
const fetchNextAppointments = ({ appointmentModel, doctorGuid, isViewAllAvailability, promise }) => (
    {
...
const cancelAppointment = ({ appointmentGuid, cancelReason, canceledBy, promise, suggestedDateTime }) => (
    {
