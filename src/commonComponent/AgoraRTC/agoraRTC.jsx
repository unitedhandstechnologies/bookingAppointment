...
const AgoraRTC = (props) => {
  ...
  const initAgora = async () => {
    client.on("user-published", async (user, mediaType) => {
      ...
      if (mediaType === "video") setUsers(prevUsers => {
    ...
    client.on("user-unpublished", (user, mediaType) => {
      if (mediaType === "video") setUsers(prevUsers => prevUsers.filter(User => User.uid !== user.uid))
  ...
  return (
    <>
      <Sidebar setShowSidebar={setShowSidebar} showSidebar={showSidebar} appointmentGuid={appointmentGuid} />
