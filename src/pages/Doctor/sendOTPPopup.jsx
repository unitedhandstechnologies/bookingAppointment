...
class ChangePasswordPopup extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="modal send-otp-model" style={{ display: "block" }} id="send-otp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">{t('Doctor.SendOtpPopup.Mobile_OTP')}</h5>
                            <button type="button" className="close send-otp-close" onClick={this.handleSendOTPPopupClick}>
                        ...
                        <div className="modal-body">
                            <div className="verification-code-section p-5">
                                <div className="divForm">
                                    ...
                                    <div>
                                        <p className="text-muted">{t('Doctor.SendOtpPopup.We_have_sent_to_OTP_code_to')}</p>
                                        <p className="verification-email">{this.props.OTPMobileNo}</p>
                                    </div>
                                    <div>
                                        <p>{t('Doctor.SendOtpPopup.Please_enter_the_code_you_received_below')}</p>
                                    ...
                                    <div className="mt-3">
                                        <a className="btn MyButton verification-code-button" onClick={this.OnSubmitOTP.bind(this)} role="button">{t('Doctor.SendOtpPopup.Submit')}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
