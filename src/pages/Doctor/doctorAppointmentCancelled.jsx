                ...
                <div>
                  ...
                  <div className="row my-4">
                    <div className="search-bar-text-input col-md-7 top-search">
                      ...
                      <div className="col-lg-4 float-start">
                        <input
                          ...
                          className="form-control"
                          placeholder={t(
                            "Doctor.AppointmentCancelled.Search_Appointment_Doctor_Name"
                          )}
                    ...
                    <div className="search-bar-text-input col-md-2">
                      ...
                      >
                        {t("Doctor.AppointmentCancelled.Search")}
                      </button>
                    </div>
                  </div>
                        ...
                        <table className="table table-bordered appointmentTable">
                          <thead>
                            <tr className="new-patient-table-title">
                              <th rowspan="2">
                                {t("Doctor.AppointmentCancelled.Booking_ID")}
                              </th>
                              <th rowspan="2">
                                {t("Doctor.AppointmentCancelled.Booking_ID")}
                              </th>
                              ...
                              <th rowspan="2">
                                {t(
                                  "Doctor.AppointmentCancelled.Medical_Specialty"
                                )}
                              </th>
                              <th rowspan="2">
                                {t("Doctor.AppointmentCancelled.Amount_(€)")}
                              </th>
                              <th rowspan="2">
                                {t(
                                  "Doctor.AppointmentCancelled.Appointment_Type"
                                )}
                              </th>
                              <th rowspan="2">
                                {t("Doctor.AppointmentCancelled.Cancelled_By")}
                              </th>
                              <th rowspan="2">
                                {t("Doctor.AppointmentCancelled.Reason")}
                              </th>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(DoctorAppointmentCancelled));
