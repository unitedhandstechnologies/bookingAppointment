...
class AdditionalServices extends Component {
  ...
  setAdditionalServiceModal = (show, newtitle = null, id = null, modalServiceName = "", modalDescription = "", modalAmount = null) => {
    this.setState({
        ...
        <div className="row search-bar d-flex align-items-center  bg-light">
          ...
          <button
            ...
            onClick={() => {
              ...
              this.setAdditionalServiceModal(true, "Doctor.MyFees.AdditionalServices.Add_New_Services")
            }}
              ...
              <table className="table table-bordered appointmentTable">
                <thead>
                  <tr className="new-patient-table-title">
                    <th>{t("Doctor.MyFees.AdditionalServices.Additional_Services")}</th>
                        ...
                        <td>
                          <div className='d-flex justify-content-between'>
                            ...
                            <button
                              ...
                              style={{ backgroundColor: "#0dcaf0", color: "white" }}
                              onClick={() => this.setAdditionalServiceModal(true, "Edit Additional Service", addService.serviceGuid, addService.serviceName, addService.description, addService.amount)}
                            >
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                this.setState({ serviceGuid: addService.serviceGuid })
                              }}
                            >
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(AdditionalServices));