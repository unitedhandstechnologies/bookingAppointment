...
class LandingPageHeader extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      IsUserLogedIn:
        localStorage.getItem("user-fullname") == null ? false : true,
    });
  }
    ...
    return (
      <>
          ...
          <div className="mobile-nav w-100 justify-content-between">
            ...
            >
              <img
                ...
                className="mobile-menu-item-menu img-fluid"
              />
            </div>
                ...
                <ul className="navbar-nav ml-auto nav-top-menu d-flex align-items-center">
                  <li className="nav-item">
                    <NavLink
                      ...
                      activeStyle={{ fontWeight: "bold", color: "#436B95" }}
                    >
                      {t("Book_an_Appoinment")}
                    </NavLink>
                  </li>
                  <li className="nav-item">
                    <NavLink
                      ...
                      <div>
                        <div className="d-flex align-items-center">
                          <div className="nav-item dropdown dropdown-menu-third position-static w-100">
                            <a
                              className="nav-link dropdown-toggle landing-dropdown-toggle"
                              id="navbarDropdown=3"
                              role="button"
                            ...
                            >
                              <div className="row">
                                <div className="col-md-12">
                                  <a
                                    onClick={this.UpdateLoginType.bind(
                                      this,
                                      "Doctor"
                                    )}
        ...
        <Modal
          className=""
          show={mobileNavModal}
          onHide={() => this.mobileNavModalShow(false)}
          style={{ zIndex: "2" }}
        >
          <div
            className="modify-modal mobile-nav-modal-menu"
            id="withdraw-modal"
            tabIndex="-1"
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  ...
                  <button
                    type="button"
                    className="close language-close"
                    data-dismiss="modal"
                    aria-label="Close"
                    onClick={() => this.mobileNavModalShow(false)}
                  >
                ...
                <div className="modal-body menu-container">
                  <div className="row">
                    <div className="col-12">
                      ...
                      <a
                        onClick={this.UpdateLoginType.bind(this, "Doctor")}
                        className="dropdown-item dropdown-item-signup"
                      >
                        {t("Doctor-Login")}
                      </a>
                      <a
                        onClick={this.UpdateLoginType.bind(this, "Patient")}
                        className="dropdown-item dropdown-item-signup"
                      >
                        {t("User_Login")}
                      </a>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(LandingPageHeader));
