...
export class CalendarView extends Component {
    ...
    getBookedAppointments() {
        ...
        promiseWrapper(this.props.docactions.getBookedAppointments, { params }).then(data => {
            ...
            const schedulerData = info.map(list => {
                ...
                return {
                    ...
                    endDate: moment(list.appointmentDateTime).add(duration, "minutes").toISOString(),
    ...
    render() {
        ...
        return (
            <div className="row mt-3 d-flex justify-content-center">
                <Paper>
                    <Scheduler
                        data={this.state.schedulerData1}
                    >
                        <ViewState
                        ...
                        <Appointments
                            appointmentComponent={({ ...rest }) =>
                                <Appointments.Appointment {...rest} onClick={e => toggleViewAppointment(e.data.appointmentGuid)} />} />
                    </Scheduler>
                </Paper>
                <DoctorFooter />
            </div>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(CalendarView));
