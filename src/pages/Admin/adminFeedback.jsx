...
const AdminFeedback = (props) => {
  ...
  const getPageData = () => {
    promiseWrapper(props.adminactions.getAllReviews, {
      paging: {
        pageSize: 10,
  ...
  const deleteReview = () => {
    ...
    promiseWrapper(props.adminactions.deleteReviewById, {
      reviewGuid: { reviewGuid: deleteId },
    })
      .then((data) => {
        if (data?.data) {
                          ...
                          {reviewList.length > 0 ? (
                              ...
                              <tr key={i}>
                                ...
                                <td>
                                  {data.createdDate ? (
                                    ...
                                    <>
                                      {t("Admin.AdminFeedback.Not_Available")}
                                    </>
                                  )}
                                </td>
                                <td>
                            ...
                            <tr>
                              <td colSpan={7} className="empty-list">
                                {t("EmptyListMessages.feedback_list")}
                              </td>
                            </tr>
                          )}
                        </tbody>
