...
class AdminLoginBox extends React.Component {
    ...
    OnLogin = (event) => {
        ...
        if (errorMessage != '') {
            ...
            promiseWrapper(this.props.actions.loginUser, { email: this.state.EmailAddress, password: this.state.Password, userType: 3 })
                .then((data) => {
            ...
            <div className="login-tab">
                <ul className="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                    <li className="nav-item">
                        <a className="nav-link active" id="pills-login-tab" data-toggle="pill" href="#pills-login" role="tab" aria-controls="pills-login" aria-selected="true">Admin Login</a>
                    </li>
                </ul>
                <div className="tab-content login-section" id="pills-tabContent">
                    <div className="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
                        <div className="tab-pane fade show active" id="nav-login" role="tabpanel" aria-labelledby="nav-login-tab">
                            <form className="divForm login-page" onSubmit={this.OnLogin.bind(this)}>
                                ...
                                <div className="divFormRow relative-position my-3">
                                    ...
                                    <InputBox
                                        ...
                                        Id="txtPassword" />
                                    <a onClick={this.togglePasswordShow.bind(this)}><i className="far fa-eye-slash times-icon" id="togglePassword"></i></a>

                                </div>
                                <div className="divFormRow pull-right mt-3">
                                    <span className="float-end"><a className="forgetPassword" onClick={this.ForgotPassword.bind(this)}>{t('Forget_Password')}</a></span>
                                </div>
                                <ButtonComponent Style={{ margin: "10px 0 0 0" }} ID='btnLogin' Type="submit" ClassName="btn MyButton" Text={t('Login')} />
                            </form>
                        </div>
                    </div>
                </div>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(AdminLoginBox));