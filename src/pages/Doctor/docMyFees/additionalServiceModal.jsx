...
class AdditionalServiceModal extends Component {
  ...
  render() {
    ...
    return (
      <Modal
        show={additionalServiceModal}
        onHide={() => setAdditionalServiceModal(false)}
        style={{ zIndex: "2" }}
        centered
      >
        <div
            ...
            <div className="modal-content">
              ...
              <div className="modal-body modify-modal-body">
                <form
                  ...
                  onSubmit={(e) => saveAdditionalService(e, this.state)}
                >
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t("Doctor.MyFees.AdditionalServiceModal.Service_Name")}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t("Doctor.MyFees.AdditionalServiceModal.Description")}
                    </label>
                    <input
                      type="text"
                      className="form-control appointment-details-form-inputs"
                  ...
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t("Doctor.MyFees.AdditionalServiceModal.Amount")}
                    </label>
                    <input
                      type="number"
                      className="form-control appointment-details-form-inputs"
