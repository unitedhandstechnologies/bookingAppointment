                  ...
                  <div className="row">
                    <div className="search-bar-text-input col-lg-10 col-md-9 top-search">
                      <input
                        ...
                        placeholder={t("Doctor.MyFAQ.Search")}
                      />
                    </div>
                    <div className="search-bar-text-input col-lg-2 col-md-3">
                      <button
                        type="button"
                        onClick={this.toggleAddFAQPopUp.bind(this)}
                        className="btn myfaqs-question-btn w-100"
                      >
                        {t("Doctor.MyFAQ.Add_Question")}
                      </button>
                    </div>
                  </div>
                          ...
                          <div className="col-md-12">
                            <div className="doctor-faqs-container">
                              <div className="doctor-faqs-header">
                                <div className="doctor-faqs-question">
                                  {v.question}
                                </div>
                                <div className="d-flex">
                                  <div className="doctor-faqs-delete-btn">
                                    <button
                                      type="button"
                                      onClick={this.EditFAQ.bind(
                                        this,
                                        v.doctorFAQGuid
                                      )}
                                      className="btn doctor-faqs-delete-btn"
                                    >
                                      {t("Doctor.MyFAQ.Edit")}
                                    </button>
                                  </div>
                                  <div className="doctor-faqs-delete-btn">
                                    <button
                                      type="button"
                                      onClick={this.DeleteFAQ.bind(
                                        this,
                                        v.doctorFAQGuid
                                      )}
                                      className="btn doctor-faqs-delete-btn"
                                    >
                                      {t("Doctor.MyFAQ.Delete")}
                                    </button>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="divForm my-4">
                              ...
                              <div className="search-bar-text-input delete-account-textarea mb-3">
                                <input
                                  ...
                                  onChange={this.UpdateFAQQue.bind(this)}
                                  placeholder={t("Doctor.MyFAQ.Your_Question")}
                                />
                              </div>
                              <div className="search-bar-text-input delete-account-textarea">
                                <textarea
                                  ...
                                  onChange={this.UpdateFAQAns.bind(this)}
                                  rows="4"
                                  placeholder={t("Doctor.MyFAQ.Your_Answer")}
                                ></textarea>
                              </div>
