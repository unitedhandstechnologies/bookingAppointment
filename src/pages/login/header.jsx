  ...
  render() {
    ...
    return (
      <>
              ...
              >
                <ul className="navbar-nav ml-auto nav-top-menu">
                  <li className="nav-item">
                    <NavLink className="nav-link" to="/book-an-appoinment">
                      ...
                      <div className="d-flex align-items-center">
                        <div className="nav-item dropdown dropdown-menu-third position-static w-100">
                          <a
                            ...
                            aria-expanded="false"
                          >
                            {t("Login_Page.Header.Login")} /{" "}
                            {t("Login_Page.Header.Signup")}
                          </a>
                          <div
                          ...
                          >
                            <div className="row">
                              <div className="col-md-12">
                                ...
                                >
                                  {t("Login_Page.Header.Doctor_Login")}
                                </a>
                                <a
                                  onClick={this.UpdateLoginType.bind(
                                    this,
                                  ...
                                  className="dropdown-item"
                                >
                                  {t("Login_Page.Header.User_Login")}
                                </a>
                              </div>
                            </div>
                          </div>
        ...
        <div
          className="modal fade mobile-nav-modal-menu"
          id="mobilemodalmenu"
          data-backdrop="static"
          data-keyboard="false"
          tabIndex="-1"
          aria-labelledby="mobilemodalmenuLabel"
          aria-hidden="true"
        >
