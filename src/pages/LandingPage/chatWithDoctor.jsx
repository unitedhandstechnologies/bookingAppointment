    ...
    componentDidUpdate() {
        ...
        if (langCode && this.state.languageCode !== langCode) {
            this.setState({ languageCode: langCode }, () => {
                this.getCMSPageData(cmsPageNum.ChatWithDoctors, this.props.languageObj.languageId, false);
            });
        }
    }
                                ...
                                <div className="top-banner">
                                    <div className="emergency py-5">
                                        <div className="py-4 heading heading-background">
                                            <div>
                                                <span className="anyEmergency">{t("Public.ChatWithDoctor.Chat_with_Doctor")}</span>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="d-flex justify-content-center">
                                                <span className="howIt">{t("Public.ChatWithDoctor.Home")}</span>
                                                <span className="any">&nbsp;{t("Public.ChatWithDoctor.Chat_with_Doctor")}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="container performance-cards">
                                <div className="performance-card mt-2">
                                    <div className="card-image">
                                        <img src="assets/images/Group7206.png" className="img-fluid" alt="Responsive img" />
                                    </div>
                                    <div className="performance-card-text">
                                        <div className="card-count">150+</div>
                                        <div className="card-text mt-2">{t("Public.ChatWithDoctor.Experts")}</div>
                                    </div>
                                </div>
                                <div className="performance-card mt-2">
                                    <div className="card-image">
                                        <img src="assets/images/Group7207.png" className="img-fluid" alt="Responsive img" />
                                    </div>
                                    <div className="performance-card-text">
                                        <div className="card-count">15</div>
                                        <div className="card-text mt-2">{t("Public.ChatWithDoctor.Countries")}</div>
                                    </div>
                                </div>
                                <div className="performance-card mt-2">
                                    <div className="card-image">
                                        <img src="assets/images/Group7208.png" className="img-fluid" alt="Responsive img" />
                                    </div>
                                    <div className="performance-card-text">
                                        <div className="card-count">950+</div>
                                        <div className="card-text mt-2">{t("Public.ChatWithDoctor.Live_Patients")}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="card helpRight">
                                        <div className="mb-2 heading d-flex justify-content-center">
                                            <span className="howIt">{t("Public.ChatWithDoctor.How_it")}&nbsp;</span>
                                            <span className="works"> {t("Public.ChatWithDoctor.works")}</span>
                                        </div>
                                        <div className="helpRightContainer">
                                            ...
                                            <div className=" helpRight-image">
                                                <img src="assets/images/Group6976.png" className="img-fluid" alt="Responsive img" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-12">
                                    <div className="form-container">
                                        <form className="got-emergency-form">
                                            <label className="mb-2">{t("Public.ChatWithDoctor.Select_medical_speciality")}</label>
                                            <div className="search-bar-text-input mb-3">
                                                <input type="text" className="form-control" placeholder="Dentist" />
                                            </div>
                                            <label className="mb-2">{t("Public.ChatWithDoctor.Describe_symptoms")}</label>
                                            <div className="search-bar-text-input mb-3">
                                                <textarea className="form-control " id="" rows="4" placeholder="Describe problem or symptoms (Up to 100 Words)"></textarea>
                                            </div>
                                            <label className="mb-2">
                                                <div>{t("Public.ChatWithDoctor.Since_when")}</div>
                                                <div>{t("Public.ChatWithDoctor.for_example_hours")}</div>
                                            </label>
                                            <div className="search-bar-text-input mb-3">
                                                <input type="text" className="form-control" placeholder="Since..." />
                                            </div>
                                            <label className="mb-2">{t("Public.ChatWithDoctor.medication_or_treatment")}</label>
                                            <div className="search-bar-text-input mb-3">
                                                <input type="text" className="form-control" placeholder="Any medication or treatment..." />
                                            </div>
                                            <label className="mb-2">{t("Public.ChatWithDoctor.already_given_diagnosis")}</label>
                                            <div className="search-bar-text-input mb-3">
                                                <input type="text" className="form-control" placeholder="If any" />
                                            </div>
                                            <div>
                                                <label className="btn form-file-upload-btn btn-default w-100">
                                                    {t("Public.ChatWithDoctor.Attach_Documents")}<input type="file" hidden />
                                                </label>
                                            </div>
                                        </form>
                                        <div className="d-flex justify-content-between mt-3">
                                            <div className="form-text-left">
                                                <div>{t("Public.ChatWithDoctor.Chat_anonymously_for_sensitive_topics")}</div>
                                                <div className="text-muted">{t("Public.ChatWithDoctor.Dr_can_see_Profile_and_diagnosis_history")}</div>
                                            </div>
                                        ...
                                        <div className="d-flex justify-content-between mt-3">
                                            <div className="form-text-left">
                                                ...
                                                <div className="per-consultation">{t("Public.ChatWithDoctor.Per_Consultation")}</div>
                                            </div>
                                            <div className="form-text-right mt-3">
                                                <div>{t("Public.ChatWithDoctor.Wallet_Balance")}</div>
                                                <div className="balance">€ 100.00</div>
                                                <div className="add-balance">{t("Public.ChatWithDoctor.Add_funds")}</div>
                                            </div>
                                        </div>
                                        <div className="d-flex justify-content-center">
                                            <button type="submit" className="btn my-4 form-call-btn">{t("Public.ChatWithDoctor.Book_Chat")}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(ChatWithDoctor));