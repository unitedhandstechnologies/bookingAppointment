...
class ChangePasswordPopup extends React.Component {
  ...
  OnChangePassword = (event) => {
    ...
    if (this.state.NewPWD == "") {
      ...
      errorMessage +=
        "Please enter valid password e.g. 8 digit, contains one Upper and Lower case character, one special character and one digit. \n";
    }
    ...
    promiseWrapper(this.props.actions.changePassword, {
  ...
  render() {
    ...
    return (
      <div
        className="modal patient-general-setting-change-password"
        style={{ display: "block" }}
        tabindex="-1"
        role="dialog"
      >
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <span
              className="close h4 text-end me-2"
              onClick={this.handleChangePasswordPopupClick}
            >
              &times;
            </span>
              ...
              <div className="divForm my-4">
                ...
                <div className="d-flex flex-column text-center">
                  ...
                  <div>
                    <p className="text-muted">
                      {t(
                        "Doctor.ChangepasswordPopup.Your_new_password_must_be_different_from_previously_used_passwords."
                      )}
                    </p>
                  </div>
                </div>
                <div className="divFormRow px-2 mb-3 relative-position">
                  <label className="form-label w-100 old-password-label">
                    {t("Doctor.ChangepasswordPopup.Old_Password")}
                  </label>
                  <InputBox
                    ...
                    Id="OldPWD"
                  />
                  <a onClick={this.toggleOldPWDShow.bind(this)}>
                    <i
                ...
                <div className="divFormRow px-2 mb-3 relative-position">
                  <label className="form-label w-100 new-password-label">
                    {t("Doctor.ChangepasswordPopup.New_Password")}
                  </label>
                  <InputBox
                    ...
                    Id="NewPWD"
                  />
                  <a onClick={this.toggleNewPWDShow.bind(this)}>
                    <i
                      className="far fa-eye-slash times-icon"
                      id="txtNewPWD"
                    ></i>
                ...
                <div className="divFormRow px-2 mb-3 relative-position">
                  <label className="form-label w-100 new-password-label">
                    {t("Doctor.ChangepasswordPopup.Re-enter_password")}
                  </label>
                  <InputBox
                    ...
                    Class="form-control icon-input"
                    PlaceHolder={t(
                      "Doctor.ChangepasswordPopup.Re-enter_password"
                    )}
                    Value={this.state.ConfirmPWD}
                    Id="ConfirmPWD"
                  />
                  <a onClick={this.toggleConfirmPWDShow.bind(this)}>
                    <i
                      className="far fa-eye-slash times-icon"
                      id="txtConfirmPWD"
                    ></i>
                ...
                <div className="mt-3">
                  <a
                    ...
                    role="button"
                    data-toggle="modal"
                    data-target=".patient-general-setting-reset-password-btn"
                  >
                    {t("Doctor.ChangepasswordPopup.Reset_Password")}
                  </a>
                </div>
              </div>
            </div>
