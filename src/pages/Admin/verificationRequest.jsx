...
class VerificationRequest extends React.Component {
  ...
  Approve() {
    promiseWrapper(this.props.actions.verifyDoctorProfile, {
      userGuid: this.state.DoctorProfile.userGuid,
      verificationType: 3,
      cancelReason: "",
    }).then((jsdata) => {
    ...
    return (
      <div>
              ...
              <div className="col-md-12 col-sm-12 col-lg-10 admin-mainRightPanel">
                ...
                <div className="admin-mainRightPanel-content">
                    ...
                    <div className="col-md-12">
                      <div className="admin-doctor-profile-container d-flex align-items-center w-100">
                        <div className="admin-doctor-profile d-flex justify-content-center align-items-center">
                          <img
                            src={this.state.DoctorProfile.profileImage}
                            style={{ borderRadius: "50px" }}
                          />
                        </div>
                        <div className="admin-doctor-name">
                          {this.state.DoctorProfile.firstName === "" ||
                          this.state.DoctorProfile.firstName == null
                            ? "---"
                            : this.state.DoctorProfile.firstName}
                          &nbsp;
                          {this.state.DoctorProfile.lastName === "" ||
                          this.state.DoctorProfile.lastName == null
                            ? "---"
                            : this.state.DoctorProfile.lastName}
                        </div>
                      </div>
                    ...
                    <div className="col-md-6">
                      <div className="row">
                        <div className="col-md-5">
                          ...
                          <div className="mb-2">
                            Supported Languages for consultations:
                          </div>
                        ...
                        <div className="col-md-7">
                          ...
                          <div className="mb-2 admin-doctor-value">
                            ...
                            this.state.DoctorProfile.gender == null
                              ? "---"
                              : this.state.DoctorProfile.gender}
                          </div>
                        </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-7">
                          ...
                          <div className="mb-2 admin-doctor-value">
                            ...
                            this.state.DoctorProfile.country == null
                              ? "---"
                              : this.state.DoctorProfile.country}
                          </div>
                          <div className="mb-2 admin-doctor-value">
                            ...
                            this.state.DoctorProfile.doB == null
                              ? "---"
                              : this.state.DoctorProfile.doB.substr(0, 10)}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="row  mt-5">
                    ...
                    <div className="col-md-12">
                      <div className="row">
                        <div className="col-md-3">Physician Services:</div>
                        ...
                        <div>
                          <div className="row">
                            ...
                            {this.state.DoctorProfile.ownPractice === true && (
                              <div className="col-md-9">
                                <div className="mb-2 admin-doctor-value">
                                  {this.state.DoctorProfile.practiceNumber}
                                </div>
                              </div>
                            )}
                          </div>
                          <div className="row">
                            ...
                            <div className="col-md-9">
                              {this.state.DoctorProfile.practiceDocuments !==
                                null &&
                                this.state.DoctorProfile.practiceDocuments
                                  .length > 0 &&
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="mb-2 admin-doctor-value mt-5">
                        Education
                      </div>
                      <div className="admin-ducation-info">
                        {this.state.DoctorProfile.educationModel !== null &&
                          this.state.DoctorProfile.educationModel.length > 0 &&
                          this.state.DoctorProfile.educationModel
                            .sort((a, b) =>
                              a.verificationType > b.verificationType ? -1 : 1
                            )
                            .map((d, idx) => (
                              <div>
                                <div>
                                  {d.degreeTitle} - {d.collage} --{" "}
                                  {d.passingYear}{" "}
                                  <span style={{ color: "#FF0000" }}>
                        ...
                        {this.state.DoctorProfile.educationModel === null &&
                          this.state.DoctorProfile.experienceModel.length <
                            1 && <div>---</div>}
                      </div>

                      <div className="mb-2 admin-doctor-value mt-5">
                        Current and passed work places{" "}
                        <span>( ex: Hospitals, clinics, etc)</span>
                      </div>
                      <ul className="admin-ducation-info">
                        {this.state.DoctorProfile.experienceModel !== null &&
                          this.state.DoctorProfile.experienceModel.length > 0 &&
                    ...
                    <div className="row pb-5 mt-5">
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-7">
                            <div className="mb-2 admin-doctor-value">
                              ...
                              this.state.DoctorProfile.clinicName == null
                                ? "---"
                                : this.state.DoctorProfile.clinicName}
                            </div>
                            <div className="mb-2 admin-doctor-value">
                              {this.state.DoctorProfile.clinicContact === "" ||
                              this.state.DoctorProfile.clinicContact == null
                                ? "---"
                                : this.state.DoctorProfile.clinicContact}
                            </div>
                            <div className="mb-2 admin-doctor-value">
                      ...
                      <div className="col-md-6">
                        <div className="row">
                          ...
                          <div className="col-md-7">
                            <div className="mb-2 admin-doctor-value">
                              {this.state.DoctorProfile.clinicEmail === "" ||
                              this.state.DoctorProfile.clinicEmail == null
                                ? "---"
                                : this.state.DoctorProfile.clinicEmail}
                            </div>
                            <div className="mb-2 admin-doctor-value">
                              {this.state.DoctorProfile.clinicAddress === "" ||
                              this.state.DoctorProfile.clinicAddress == null
                                ? "---"
                                : this.state.DoctorProfile.clinicAddress}
                            </div>
                            <div className="mb-2 admin-doctor-value">
                    ...
                    <div>
                      <button
                        ...
                        className="btn admin-doctor-approve-button px-4"
                      >
                        Approve
                      </button>
                      <button
                        type="button"
                        onClick={this.togglePop.bind(this, 5)}
                        className="btn admin-doctor-approve-button px-4"
                      >
                      ...
                      <button
                        type="button"
                        onClick={this.togglePop.bind(this, 4)}
                        className="btn admin-doctor-reject-button px-4"
                      >
                        Reject
                      </button>
                    </div>
        ...
        {this.state.rejectPopup ? (
          <RejectPopup
            buttonActionValue={this.state.buttonAction}
            ...
            docUserId={
              this.state.DoctorProfile.userGuid === "" ||
              this.state.DoctorProfile.userGuid == null
                ? "---"
                : this.state.DoctorProfile.userGuid
            }
          />
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(VerificationRequest));
