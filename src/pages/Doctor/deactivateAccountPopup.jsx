...
class DeactivateAccountPopup extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className="modal delete-your-account"
        style={{ display: "block" }}
        tabindex="-1"
        role="dialog"
      >
            ...
            <div className="modal-body">
              <div className="divForm m-4">
                <div className="d-flex justify-content-center">
                  <img
                    src="assets/images/Group8169.png"
                ...
                <div className="d-flex flex-column text-center">
                  <div className="patient-forget-password-text mt-4">
                    <p>
                      {t(
                        "Doctor.DeactivateAccountPopup.Were_sorry_to_see_you_go."
                      )}
                    </p>
                  </div>
                  <div className="d-flex justify-content-center">
                    <p className="text-muted w-75">
                      {t(
                        "Doctor.DeactivateAccountPopup.Are_you_sure_you_want_to_delete_your_account?_If_you_delete_your_account_you_will_permanently_lose_your_profile."
                      )}
                    </p>
                  </div>
                </div>
                <label className="mb-2">
                  {t("Doctor.DeactivateAccountPopup.Message")}
                </label>
                <div className="search-bar-text-input delete-account-textarea mb-3">
                  <textarea
                    ...
                    rows="4"
                    placeholder={t(
                      "Doctor.DeactivateAccountPopup.Your_Message"
                    )}
                  ></textarea>
                </div>
                <div className="d-flex">
                  <button
                    type="button"
                    onClick={this.handleDeactivateAccountClick}
                    className="btn MyButton w-50 mx-3"
                    data-dismiss="modal"
                  >
                    {t("Doctor.DeactivateAccountPopup.Cancel")}
                  </button>
                  <button
                    type="button"
                    onClick={this.OnAccountAction}
                    className="btn btn-outline-danger w-50 delete-account-btn mx-3"
                    role="button"
                    data-toggle="modal"
                    data-target=".delete-your-account-okay"
                  >
                    {this.props.user === "Doctor"
                      ? "Deactivate Account"
                      : "Delete Account"}
                  </button>
                </div>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(DeactivateAccountPopup));
