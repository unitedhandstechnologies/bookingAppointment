...
class BookAnAppoinmentDoctorView extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.appoinmentModel.appointmentType === 1) { this.setState({ appoinmentType: "Video" }); }
        else if (this.props.appoinmentModel.appointmentType === 2) { this.setState({ appoinmentType: "Clinic" }); }
        else if (this.props.appoinmentModel.appointmentType === 3) { this.setState({ appoinmentType: "Chat" }); }
    }
    ...
    getAppointmentData() {
        promiseWrapper(this.props.patientactions.searchDoctorAppointment, { appointmentModel: this.state.anAppoinmentModel, doctorGuid: this.props.match.params.docGuid }).then((jsdata) => {
            ...
            <div>
                ...
                <div className="doctor-profile-container">
                    <div className="container">
                            ...
                            <div className="col-md-12 col-lg-6">
                                <div className="dotor-item-container">
                                    <div className="doctor-item-left">
                                        <img src={this.state.docDeatils.doctorImage} alt="" className="img-fluid top-doctor-image rounded-circle" />
                                    </div>
                                    <div className="doctor-item-right">
                                        <a className="doctor-name-link">
                                            {this.state.docDeatils.firstName === "" || this.state.docDeatils.firstName == null ? "---" : this.state.docDeatils.firstName}&nbsp;
                                            {this.state.docDeatils.lastName === "" || this.state.docDeatils.lastName == null ? "---" : this.state.docDeatils.lastName}
                                        </a>
                                        ...
                                        <div>
                                            <span className="doctor-year">{this.state.docDeatils.experience} {t('Public.Appointment.Years')} </span>
                                        ...
                                        <div className="doctor-visit">
                                            <div className="doctor-visit-container">
                                                <div className="visit-pills">
                                                    <span><img src="assets/images/Person.png" alt="Person.png" className="img-fluid" /></span>
                                                    <span>{t('Public.SearchDoctorAppointment.InPersonVisit')}</span>
                                                </div>
                                            </div>
                                            <div className="doctor-visit-container">
                                                <div className="visit-pills">
                                        ...
                                        <div className="doctor-charges">
                                            <div className="d-flex">
                                                <div className="question-rate2">
                                                    <div className="question-rate21">{this.state.docDeatils.doctorCurrency} {this.state.docDeatils.chatFees}</div>
                                                    <div className="question-status">{t('Public.Appointment.Per3Question')}</div>
                                                </div>
                                                <div className="question-rate2">
                                                    <div className="question-rate22">{this.state.docDeatils.doctorCurrency} {this.state.docDeatils.onlineAppointmentFees}</div>
                                                    <div className="question-status">{t('Public.Appointment.Online')}</div>
                                                </div>
                                                <div className="question-rate2">
                                                    <div className="question-rate23">{this.state.docDeatils.doctorCurrency} {this.state.docDeatils.inclinicAppointmentFees}</div>
                                ...
                                <div className="doctor-details">
                                    <div className="doctor-details-left">
                                        <img src="assets/images/About.png" alt="About.png" className="img-fluid doctor-details-left-icon" />
                                        <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.AboutDoctor')}</div>
                                    </div>
                                ...
                                <div className="doctor-details">
                                    <div className="doctor-details-left">
                                        <img src="assets/images/Location1.png" alt="Location1.png" className="img-fluid doctor-details-left-icon" />
                                        <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.Address')}</div>
                                    </div>
                                    <div className="doctor-details-right">
                                        <div className="doctor-details-right-text">
                                            <span>{this.state.docDeatils.address}</span><br />
                                            <span>{this.state.docDeatils.city}, {this.state.docDeatils.state}, {this.state.docDeatils.zip}, {this.state.docDeatils.country}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="doctor-details">
                                    <div className="doctor-details-left">
                                        <img src="assets/images/Contact.png" alt="Contact.png" className="img-fluid doctor-details-left-icon" />
                                        <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.Contact')}</div>
                                    </div>
                                    <div className="doctor-details-right">
                                        <div className="doctor-details-right-text">
                                            <span>{this.state.docDeatils.contact}</span><br />
                                        </div>
                                    </div>
                                </div>
                                {/* <div className="doctor-details">
                                ...
                                <div className="doctor-details">
                                    <div className="doctor-details-left">
                                        <img src="assets/images/Group10073.png" alt="Group10073.png" className="img-fluid doctor-details-left-icon" />
                                        <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.Specializations')}</div>
                                    </div>
                                    <div className="doctor-details-right">
                                        <div className="doctor-details-right-text">
                                            {this.state.docDeatils.physicianServices.map((v, idx) => {
                                ...
                                <div className="doctor-details">
                                    <div className="doctor-details-left">
                                        <img src="assets/images/Education.png" alt="Education.png" className="img-fluid doctor-details-left-icon" />
                                        <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.Education')}</div>
                                    </div>
                                    <div className="doctor-details-right">
                                        <div className="doctor-details-right-text">
                                            {this.state.docDeatils.educationModel.map((v, idx) => {
                                                return (<div><span>{v.degreeTitle} - {v.collage}, {v.passingYear}</span><br /></div>)
                                            })
                                            }
                                        </div>
                                    </div>
                                ...
                                <div className="doctor-details">
                                    <div className="doctor-details-left">
                                        <img src="assets/images/Experience.png" alt="Experience.png" className="img-fluid doctor-details-left-icon" />
                                        <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.Experience')}</div>
                                    </div>
                                    <div className="doctor-details-right">
                                        <div className="doctor-details-right-text">
                                            {this.state.docDeatils.experienceModel.map((v, idx) => {
                                                return (<div><span>{v.startDateYear} - {v.endDateYear} - {v.organizationName}</span><br /></div>)
                                            })
                                            }
                                        </div>
                                    </div>
                            ...
                            <div className="col-md-12 col-lg-6">
                                <div className="doctor-timing-container doctor-timing-container-gray">
                                    <div className="doctor-timing-container-title">
                                        <h4>{t('Public.SearchDoctorAppointment.Book_Your_Appointment')}</h4>
                                    </div>
                                    ...
                                    <div className="web-timing-slider">
                                        <div className="doctor-timing-type-radios">
                                            <div className="form-check  timing-type-radio">
                                                ...
                                                <label className="form-check-label" for="inlineRadio1">{t('Public.Appointment.InClinic')}</label>
                                            </div>
                                            <div className="form-check  timing-type-radio">
                                                <input className="form-check-input"
                                                    type="radio"
                                                    ...
                                                    onChange={this.UpdateAppoinmentType.bind(this)} />
                                                <label className="form-check-label" for="inlineRadio2">{t('Public.Appointment.VideoVisit')}</label>
                                            </div>
                                            <div className="form-check ">
                                                <input className="form-check-input"
                                                    ...
                                                    onChange={this.UpdateAppoinmentType.bind(this)} />
                                                <label className="form-check-label" for="inlineRadio2">{t('Public.SearchDoctorAppointment.ChatWithDoctor')}</label>
                                            </div>
                                        </div>
                                        <div className="doctor-timing-type-appoitnment">
                                        ...
                                        <div className="doctor-timing-slider">
                                            ...
                                            <CommonCalender key={this.state.docDeatils.availableSlots} CalData={this.state.docDeatils.availableSlots} DocGuid={this.state.docGuid} CallBackAppointmentSave={this.CallBackAppointmentSave.bind(this, this.state.docGuid)} />
                                            {/* } */}
                                        </div>
                                    </div>
                                    <div className="check-availability d-flex justify-content-end">
                                        <a style={{ cursor: "pointer" }} onClick={this.toggleViewAllAvailability.bind(this)}>{t('Public.Appointment.ViewAllAvailability')}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        {this.state.docDeatils.faQs && this.state.docDeatils.faQs.length > 0 &&
                            <div className="row">
                                <div className="col-md-12 col-lg-6">
                                    <div className="doctor-details">
                                        <div className="doctor-details-left">
                                            <img src="assets/images/FAQs.png" alt="FAQs.png" className="img-fluid doctor-details-left-icon" />
                                            <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.FAQs')}</div>
                                        </div>
                                    </div>
                                    {this.state.docDeatils.faQs.map((v, idx) => (
                                        <div className="doctor-details">
                                            <div className="doctor-details-left">
                                                ...
                                                <div className="doctor-details-left-title">{v.question}</div>
                                            </div>
                                            <div className="doctor-details-right">
                                                <div className="doctor-details-right-text">
                                                    {v.answer}
                        ...
                        <hr />
                        {this.state.docDeatils.reviews && this.state.docDeatils.reviews.length > 0 &&
                            <div className="row">
                                <div id="doctor-all-reviews">
                                    <div className="doctor-details">
                                        <div className="doctor-details-left">
                                            <img src="assets/images/Patient.png" alt="Patient.png" className="img-fluid doctor-details-left-icon" />
                                            <div className="doctor-details-left-title">{t('Public.SearchDoctorAppointment.PatientReview')}</div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="doctor-details">
                                            <div className="doctor-details-left">
                                                <div className="d-flex align-items-center">
                                                    <i className="fas fa-circle doctor-details-left-icon"></i>
                                                    <div className="doctor-details-left-title">{v.patientFirstname} {v.patientLastName}
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="doctor-details-right">
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(BookAnAppoinmentDoctorView));