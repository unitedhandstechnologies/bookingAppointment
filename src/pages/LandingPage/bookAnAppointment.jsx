  ...
  componentDidMount() {
    promiseWrapper(this.props.docactions.getLanguages).then((data) => {
      this.setState({ LanguageData: data }, () => {
        promiseWrapper(this.props.docactions.getPhysicianService).then(
          (jsdata) => {
            this.setState({ PhysicianServiceList: jsdata }, () => {
                  ...
                  if (
                    ...
                    this.setState(
                      ...
                      () => {
                        ...
                        if (
                          this.state.anAppoinmentModel.physicianService !==
                            undefined &&
                          this.state.anAppoinmentModel.physicianService.length >
                            0
                        ) {
                          this.setState({
                            PhysicianServiceLable: `${
                              this.state.PhysicianServiceList.filter(
                                (t) =>
                                  t.physicianServiceId ===
                                  Number(
                                    this.state.anAppoinmentModel
                                      .physicianService[0]
                                  )
                              )[0].physicianServiceName
                            } + (${
                              this.state.anAppoinmentModel.physicianService
                                .length - 1
                            })`,
              ...
              promiseWrapper(this.props.patientactions.getLocation).then(
                (ldata) => {
                  this.setState({ LocationList: ldata }, () => {
                    promiseWrapper(
                      this.props.patientactions.searchAppointment,
                      ...
                      this.setState((prevState) => ({
                        anAppoinmentModel: {
                          ...prevState.anAppoinmentModel,
                          ["physicianService"]:
                            this.state.anAppoinmentModel.physicianService.map(
                              (v) => v.toString()
                            ),
                        },
                      }));
  ...
  UpdatePreferredLanguage = (e) => {
    this.setState(
      (prevState) => ({
        anAppoinmentModel: {
          ...prevState.anAppoinmentModel,
          ["languageId"]: e.map((v) => parseInt(v, 10)),
        },
      }),
      () => {
        this.props.patientactions.updateAppoimentModel(
        ...
        if (
          this.state.anAppoinmentModel.languageId !== undefined &&
          this.state.anAppoinmentModel.languageId.length > 0
        ) {
          this.setState({
            LanguageLable: `${
              this.state.LanguageData.filter(
                (t) =>
                  t.languageId ===
                  Number(this.state.anAppoinmentModel.languageId[0])
              )[0].languageName
            } + (${this.state.anAppoinmentModel.languageId.length - 1})`,
          });
        } else {
  ...
  UpdatephysicianService = (e) => {
    this.setState(
      (prevState) => ({
        anAppoinmentModel: {
          ...prevState.anAppoinmentModel,
          ["physicianService"]: e.map((v) => parseInt(v, 10)),
        },
      }),
      () => {
        this.props.patientactions.updateAppoimentModel(
        ...
        if (
          this.state.anAppoinmentModel.physicianService !== undefined &&
          this.state.anAppoinmentModel.physicianService.length > 0
        ) {
          this.setState({
            PhysicianServiceLable: `${
              this.state.PhysicianServiceList.filter(
                (t) =>
                  t.physicianServiceId ===
                  Number(this.state.anAppoinmentModel.physicianService[0])
              )[0].physicianServiceName
            } + (${this.state.anAppoinmentModel.physicianService.length - 1})`,
          });
        } else {
          this.setState({ PhysicianServiceLable: "" });
        }
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12">
                  <nav>
                    ...
                    >
                      <a
                        ...
                        id="nav-list-view-tab"
                        data-toggle="tab"
                        href="#nav-list-view"
                        role="tab"
                        aria-controls="nav-list-view"
                        aria-selected="true"
                      >
                        <i className="fas fa-list-ul mx-2"></i>List View
                      </a>
                  ...
                  <div className="tab-content" id="nav-tabContent">
                    <div
                      className="tab-pane fade show active all-content-slider"
                      id="nav-list-view"
                      role="tabpanel"
                      aria-labelledby="nav-list-view-tab"
                    >
                      <div className="col-lg-12 col-md-12">
                        <nav>
                          <div
                          ...
                          >
                            <a
                              ...
                              href="#nav-inclinic"
                              role="tab"
                              aria-controls="nav-inclinic"
                              aria-selected="false"
                              onClick={this.ChangeAppoinmentType.bind(this, 2)}
                            >
                              {t("Public.Appointment.InClinic")}
                            </a>
                            <a
                              className="nav-link"
                              id="nav-videovisit-tab"
                              data-toggle="tab"
                              href="#nav-videovisit"
                              role="tab"
                              aria-controls="nav-videovisit"
                              aria-selected="false"
                              onClick={this.ChangeAppoinmentType.bind(this, 1)}
                            >
                        ...
                        <div
                          className="tab-content all-content"
                          id="nav-tabContent"
                        >
                          <div
                            ...
                            id="nav-inclinic"
                            role="tabpanel"
                            aria-labelledby="nav-inclinic-tab"
                          >
                            <div
                              className="tab-pane fade show active"
                              id="nav-all"
                              ...
                              {this.state.LoadData === true && (
                                <div className="tab-pills d-flex">
                                  <input
                                    ...
                                    value={
                                      this.state.anAppoinmentModel["appDate"]
                                    }
                                  />
                                  <select
                                    value={
                                      this.state.anAppoinmentModel["location"]
                                    }
                                    onChange={this.UpdateLocation.bind(this)}
                                    className="form-control tab-pills-div"
                                  >
                                    <option value="0">
                                      {t("Public.SearchAppointment.Location")}
                                    </option>
                                    {this.state.LocationList.map((h, i) => (
                                  ...
                                  <DropdownMultiselect
                                    ...
                                    placeholder={t(
                                      "Public.SearchAppointment.Specialities"
                                    )}
                                    placeholderMultipleChecked={
                                      this.state.PhysicianServiceLable
                                    }
                                  ...
                                  <select
                                    value={
                                      this.state.anAppoinmentModel["isMale"]
                                    }
                                    onChange={this.UpdateGender.bind(this)}
                                    className="form-control tab-pills-div"
                                  >
                                    <option value="0">
                                      {t("Public.SearchAppointment.Gender")}
                                    </option>
                                    <option value="1">
                                      {t("Public.Appointment.Male")}
                                    </option>
                                    <option value="2">
                                      {t("Public.Appointment.Female")}
                                    </option>
                                    <option value="3">
                                      {t("Public.Appointment.Other")}
                                    </option>
                                  </select>
                                  <DropdownMultiselect
                                    selected={
                                      this.state.anAppoinmentModel["languageId"]
                                    }
                                    buttonClass="selectpicker tab-pills-div"
                                    placeholder={t(
                                      "Public.SearchAppointment.Language"
                                    )}
                                    placeholderMultipleChecked={
                                      this.state.LanguageLable
                                    }
                                    handleOnChange={this.UpdatePreferredLanguage.bind(
                                      this
                                    )}
                                  ...
                                  />
                                  <button
                                    className="btn tab-pills-div tab-pills-div-search"
                                    onClick={this.UpdateDocSearch.bind(this)}
                                  >
                                    {t("Public.Appointment.Search")}
                                  </button>
                                </div>
                              )}
                              {this.state.docDetailList.length > 0 ? (
                                this.state.docDetailList.map((v, idx) => (
                                  <>
                                    <div
                                      className="row doctor-list-row"
                                      key={idx}
                                    >
                                          ...
                                          <div className="doctor-item-right w-100 mx-2">
                                            ...
                                            <div>
                                              ...
                                              <span className="doctor-exp">
                                                {" "}
                                                {t(
                                                  "Public.Appointment.OfExperience"
                                                )}{" "}
                                              </span>
                                            </div>
                                              ...
                                              <div className="d-flex">
                                                <div className="question-rate2">
                                                  ...
                                                  <div className="question-status">
                                                    {t(
                                                      "Public.Appointment.Per3Question"
                                                    )}
                                                  </div>
                                                </div>
                                                <div className="question-rate2">
                                                  <div className="question-rate22">
                                                    {v.doctorCurrency}{" "}
                                                    {v.onlineAppointmentFees}
                                                  </div>
                                                  <div className="question-status">
                                                    {t(
                                                      "Public.Appointment.Online"
                                                    )}
                                                  </div>
                                                </div>
                                                <div className="question-rate2">
                                                  <div className="question-rate23">
                                                    {v.doctorCurrency}{" "}
                                                    {v.inclinicAppointmentFees}
                                                  </div>
                                                  <div className="question-status">
                                                    {t(
                                                      "Public.Appointment.InClinic"
                                                    )}
                                                  </div>
                                                </div>
                                              </div>
                                      ...
                                      <div className="check-availability doctor-list-check-availability">
                                        <a
                                          ...
                                          onClick={this.toggleViewAllAvailability.bind(
                                            this,
                                            v.doctorGuid
                                          )}
                                        >
                                          {t(
                                            "Public.Appointment.ViewAllAvailability"
                                          )}
                                        </a>
                                      </div>
                                ...
                                <div>
                                  <p>
                                    {t(
                                      "Public.SearchAppointment.NoDoctorsFoundMessage"
                                    )}
                                  </p>
                                </div>
                              )}
                          ...
                          <div
                            ...
                            id="nav-videovisit"
                            role="tabpanel"
                            aria-labelledby="nav-videovisit-tab"
                          >
                            <div
                              className="tab-pane fade show active"
                              id="nav-all"
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(withRouter(BookAnAppoinment)));
