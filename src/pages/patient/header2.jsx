                                    ...
                                    <div className="dropdown-menu dropdown-menu-third" aria-labelledby="navbarDropdown3">
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="dropdown-item">{t('Doctor.DocHeader.Overview')}</div>
                                                <div className="dropdown-item">{t('Doctor.DocHeader.My_Profile')}</div>
                                                <div className="dropdown-item">{t('Doctor.DocHeader.Logout')}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
