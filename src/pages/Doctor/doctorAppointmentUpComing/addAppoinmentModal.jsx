...
class AddAppointmentModal extends Component {
  ...
  getAvailableSlotes = (appointmentDate) => {
    promiseWrapper(this.props.patientactions.viewAllAvailability, {
      ...
      doctorGuid: localStorage.getItem(localStorageKeys.userId),
    }).then((data) => {
        ...
        if (dateSlotes.availableTime.length) {
          ...
          if (selectedDate === currentDate) {
            if (today !== selectedDate)
              this.setState({
                availableSlotes: dateSlotes.availableTime.map((dateTime) =>
                  new Date(dateTime).toLocaleTimeString("en-GB")
                ),
                appointmentTime: new Date(
                  dateSlotes.availableTime[0]
              ...
              this.setState({
                availableSlotes: filterTime.map((dateTime) =>
                  new Date(dateTime).toLocaleTimeString("en-GB")
                ),
                appointmentTime: new Date(filterTime[0]).toLocaleTimeString(
                  "en-GB"
                ),
              });
            }
  ...
  render() {
    ...
    return (
      <Modal
        show={addAppointmentModal}
        onHide={() => setAddAppointmentModal(false)}
        style={{ zIndex: 2 }}
        centered
      >
        <div
          ...
          <div className="modal-dialog mt-0 mb-0 modal-lg">
            <div className="modal-content">
              <div className="modal-header modify-modal-header">
                ...
                >
                  {t(
                    "Doctor.AppointmentUpComing.AddAppointmentModal.Patient's_Details"
                  )}
                </h5>
                <button
                  type="button"
              ...
              <div className="modal-body modify-modal-body">
                <form
                  ...
                  onSubmit={this.submitWithdrawalData.bind(this)}
                >
                  <div className="row">
                    <div className="col-sm-6">
                      <label className="mb-2">
                        {t(
                          "Doctor.AppointmentUpComing.AddAppointmentModal.First_Name"
                        )}
                      </label>
                    ...
                    <div className="col-sm-6">
                      <label className="mb-2">
                        {t(
                          "Doctor.AppointmentUpComing.AddAppointmentModal.Last_Name"
                        )}
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="row">
                        ...
                        <div className="form-group">
                          <div className="search-bar-text-input">
                            <label className="form-label">
                              {t(
                                "Doctor.AppointmentUpComing.AddAppointmentModal.Gender"
                              )}
                            </label>
                            <select
                            ...
                            >
                              <option>
                                {t(
                                  "Doctor.AppointmentUpComing.AddAppointmentModal.Male"
                                )}
                              </option>
                              <option>
                                {t(
                                  "Doctor.AppointmentUpComing.AddAppointmentModal.Female"
                                )}
                              </option>
                            </select>
                          </div>
                    ...
                    <div className="col-lg-6">
                      <label className="mb-2">
                        {t(
                          "Doctor.AppointmentUpComing.AddAppointmentModal.Phone_Number"
                        )}
                      </label>
                      <div className="search-bar-text-input delete-account-textarea">
                        <input
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="input-wrapper">
                        <label className="form-label">
                          {t(
                            "Doctor.AppointmentUpComing.AddAppointmentModal.Date"
                          )}
                        </label>
                        <input
                          type="date"
                    ...
                    <div className="col-lg-6">
                      <div className="input-wrapper">
                        <label className="form-label">
                          {t(
                            "Doctor.AppointmentUpComing.AddAppointmentModal.Time"
                          )}
                        </label>
                        <select
                          ...
                          className="form-control"
                          onChange={(e) => {
                            if (availableSlotes.length) this.setStates(e);
                          }}
                        >
                          {appointmentDate ? (
                            availableSlotes.length ? (
                              availableSlotes.map((time) => (
                  ...
                  <label className="mb-2">
                    {t(
                      "Doctor.AppointmentUpComing.AddAppointmentModal.E-mail_ID"
                    )}
                  </label>
                  <div className="search-bar-text-input delete-account-textarea">
                    <input
                  ...
                  <div className="form-group">
                    <label htmlFor="describe-problem-textarea">
                      {t(
                        "Doctor.AppointmentUpComing.AddAppointmentModal.Additional_Description"
                      )}
                    </label>
                    <textarea
                  ...
                  <div className="form-group">
                    <label htmlFor="describe-problem-textarea">
                      {t(
                        "Doctor.AppointmentUpComing.AddAppointmentModal.Symptoms"
                      )}
                    </label>
                    <textarea
                      className="form-control appointment-details-form-inputs"
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="symptoms-active">
                      {t(
                        "Doctor.AppointmentUpComing.AddAppointmentModal.Since_When"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="symptoms-active">
                      {t(
                        "Doctor.AppointmentUpComing.AddAppointmentModal.Medication"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-4">
                    <label htmlFor="symptoms-active">
                      {t(
                        "Doctor.AppointmentUpComing.AddAppointmentModal.Diagnosis"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="my-5 d-flex justify-content-around">
                    ...
                    >
                      {t(
                        "Doctor.AppointmentUpComing.AddAppointmentModal.Submit"
                      )}
                    </button>
                  </div>
                </form>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(AddAppointmentModal));
