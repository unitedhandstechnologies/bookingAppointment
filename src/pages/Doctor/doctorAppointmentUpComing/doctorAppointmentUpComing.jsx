...
class DoctorAppointmentUpComing extends React.Component {
  ...
  changeView(e) {
    this.setState({ CalendarView: Boolean(parseInt(e.target.value)) });
  }

  setAddAppointmentModal(val, reload) {
    this.setState({ addAppointmentModal: val });
    if (reload)
      this.setState((prev) => ({ getCalendarData: prev.getCalendarData + 1 }));
  }
    ...
    if (action === 1) {
      promiseWrapper(this.props.patientactions.changeAppointmentStatus, {
        ...
        if (data.data.isSuccess == true) {
          ...
          if (this.state.viewAppointmentPopup)
            this.setState({
              viewAppointmentPopup: !this.state.viewAppointmentPopup,
            });
          this.GetAppointmentRequestList();
  ...
  IsRejectAppoinment(appId) {
    this.setState({ rejectAppointmentGuid: appId }, () =>
      this.setState({
      ...
      <>
                  ...
                  <div>
                    <div className="row search-bar">
                      ...
                      <div className="view-selector col-lg-6  bg-light d-flex justify-content-between py-4 align-content-space-between">
                        ...
                        >
                          <option value="1">
                            {t("Doctor.AppointmentUpComing.Calender_View")}
                          </option>
                          <option value="0" selected={!this.state.CalendarView}>
                            {t("Doctor.AppointmentUpComing.List_View")}
                          </option>
                        </select>
                        <button
                    ...
                    {!this.state.CalendarView ? (
                        ...
                        <div className="row my-4">
                          <div className="search-bar-text-input col-md-7 top-search">
                            ...
                            <div className="col-lg-4 float-start">
                              <input
                                ...
                                className="form-control"
                                placeholder={t(
                                  "Doctor.AppointmentUpComing.Search_Appointment_Doctor_Name"
                                )}
                          ...
                          <div className="search-bar-text-input col-md-3">
                            <DropdownMultiselect
                              ...
                              placeholder={t(
                                "Doctor.AppointmentUpComing.Filter"
                              )}
                          ...
                          <div className="search-bar-text-input col-md-2">
                            <button
                              type="button"
                              onClick={this.GetAppointmentRequestList.bind(
                                this
                              )}
                              className="btn filter-btn w-100"
                            >
                              {t("Doctor.AppointmentUpComing.Search")}
                            </button>
                          </div>
                        </div>
                                ...
                                <table className="table table-bordered appointmentTable">
                                  <thead>
                                    <tr className="new-patient-table-title">
                                      <th rowSpan="2">
                                        {t(
                                          "Doctor.AppointmentUpComing.Booking_ID"
                                        )}
                                      </th>
                                      <th rowSpan="2">
                                        {t(
                                          "Doctor.AppointmentUpComing.Patient_Name"
                                        )}
                                      </th>
                                      <th>
                                        {t("Doctor.AppointmentCancelled.Date")}
                                      </th>
                                      <th rowSpan="2">
                                        {t(
                                          "Doctor.AppointmentUpComing.Medical_Specialty"
                                        )}
                                      </th>
                                      <th rowSpan="2">
                                        {t(
                                          "Doctor.AppointmentUpComing.Amount_(€)"
                                        )}
                                      </th>
                                      <th rowSpan="2">
                                        {t(
                                          "Doctor.AppointmentUpComing.Appointment_Type"
                                        )}
                                      </th>
                                      <th rowSpan="2">
                                        {t(
                                          "Doctor.AppointmentUpComing.Symptoms"
                                        )}
                                      </th>
                                      <th rowSpan="2">
                                        {t(
                                    ...
                                    <tr>
                                      <th>
                                        {t("Doctor.AppointmentCompleted.Time")}
                                      </th>
                                    </tr>
                                  </thead>
                                  {this.state && this.state.LoadedData && (
                                    <tbody>
                                      {this.state.AppointmentRequestList
                                        .length > 0 ? (
                                            ...
                                            this.isAppointmentNewUpcomming(
                                              ...
                                              <tr key={idx}>
                                                ...
                                                <td>
                                                  ...
                                                  >
                                                    {t(
                                                      "Doctor.AppointmentUpComing.View"
                                                    )}
                                                  </Link>
                                                </td>
                                                <td className="d-flex justify-content-center booking-btn">
                                                  <div className="dropdown">
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        {t(
                                                          "Doctor.AppointmentUpComing.Mark_as_complete"
                                                        )}
                                                      </a>
                                                      <a
                                                        className="dropdown-item"
                                                      ...
                                                      >
                                                        {t(
                                                          "Doctor.AppointmentUpComing.Cancel"
                                                        )}
                                                      </a>
                                                    </div>
                                                  </div>
                      ...
                      componentWithLazyLoad(CalendarView, {
                        ...
                        setCalendarView: () =>
                          this.setState((prev) => ({
                            getCalendarData: prev.getCalendarData + 1,
                          })),
                        toggleViewAppointment: (appointmentGuid) =>
                          this.toggleViewAppointment(appointmentGuid),
                      })
                    )}
                  </div>
                </div>
        ...
        {this.state.addAppointmentModal && (
          <AddAppointmentModal
            ...
            setAddAppointmentModal={(val, reload) =>
              this.setAddAppointmentModal(val, reload)
            }
          />
        )}
        ...
        {this.state.viewRejectConfirmPopup === true && (
          <AppointmentRejectConfirm
            AppointmentGuid={this.state.rejectAppointmentGuid}
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(DoctorAppointmentUpComing));
