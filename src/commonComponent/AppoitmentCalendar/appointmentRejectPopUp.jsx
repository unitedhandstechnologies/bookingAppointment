                            ...
                            <div className="divForm my-4">
                                <div className="d-flex flex-column text-center">
                                    <div className="patient-forget-password-text">
                                        <p>{t('Doctor.AppointmentRejectedPopup.Appointment_Rejected')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="text-center mb-5">
                                    <span>{t('Doctor.AppointmentRejectedPopup.Appointment_has_been_removed')}</span><br />
                                    <span>{t('Doctor.AppointmentRejectedPopup.from_your_dashborad.')}</span>
                                </div>
                                <div className="mt-3 text-center">
                                    <a className="btn MyButton reset-password-button" onClick={this.ClosePopup.bind(this)}>{t('Doctor.AppointmentRejectedPopup.Done')}</a>
                                </div>
                            </div>
                        </div>
                    </div>
