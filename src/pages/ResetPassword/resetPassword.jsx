                        ...
                        <div className="row">
                            <div className="col-3">
                                <div className="divLogo">
                                    <img src="assets/images/logo.png" width="180" alt='logo img' />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row divLoginSectionContainer">
                            <div className="col-md-7">
                                <img src="assets/images/login.png" className="loginImg" alt='login img' />
                            </div>
                            <div className="col-md-5 login-section-container p-0">
                                <div className="create-new-passowrd-section">
                                    <div className="divForm">
                                        <div className=" my-5">
                                            <img src="assets/images/Group7889.png" className="img-fluid create-new-password-img" alt="Responsive img" />
                                        </div>
                                        <div className="forget-password-text">
                                            <p>{t("ResetPassword.Create_new_password")}</p>
                                        </div>
                                        <div>
                                            <p className="text-muted">{t("ResetPassword.password_must_different")}</p>
                                        </div>
                                        <div className="divFormRow px-2 relative-position">
                                            <label className="form-label w-100 new-password-label">{t("ResetPassword.Password")}</label>
                                            <InputBox
                                                ...
                                                Id="txtPassword" />
                                            <a onClick={this.togglePasswordShow.bind(this)}><i className="far fa-eye-slash times-icon" id="toggleCPassword"></i></a>
                                        </div>
                                        <div className="divFormRow px-2 relative-position">
                                            <label className="form-label w-100 new-password-label">{t("ResetPassword.Confirm_Password")}</label>
                                            <InputBox
                                            ...
                                            <a onClick={this.toggleConPasswordShow.bind(this)}><i className="far fa-eye-slash times-icon" id="toggleConPassword"></i></a>
                                        </div>
                                        {this.state.showPasswordMsg === true &&
                                            <div className="ms-4 mb-sm-2 text-start" style={{ color: "#FF0000" }}>{t("ResetPassword.Invalid_Password")}</div>
                                        }
                                        <div className="mt-2 ms-4 text-start">
                                            {t("ResetPassword.Password_contain_8_Characters")}:
                                            <div className="ms-5">
                                                -{t("ResetPassword.One_Uppercase_Letter")}<br />
                                                -{t("ResetPassword.One_Lowercase_Letter")}<br />
                                                -{t("ResetPassword.One_Special_Character")}<br />
                                                -{t("ResetPassword.One_Digit")}
                                            </div>
                                        </div>
                                        <div className="mt-4">
                                            <ButtonComponent ID='btnSubmit' Action={this.OnResetPaswordSubmit.bind(this)} ClassName="btn MyButton new-password-button" Text="Reset Password" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(ResetPassword));