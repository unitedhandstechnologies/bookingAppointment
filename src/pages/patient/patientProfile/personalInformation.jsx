...
class PersonalInformation extends Component {
  ...
  componentDidMount() {
    this.setState({
      WebSiteLanguageData: JSON.parse(
  ...
  SendOTPText() {
    if (isEmpty(this.state.ProfilePersonalInfo["phone"])) {
      ...
      promiseWrapper(this.props.docactions.sendTextOTP, {
  ...
  updateCurrency = (currencyCode) =>
    this.setState({
      SelectedCurrency: this.selectCurrencyFromList(currencyCode),
    });

  selectCurrencyFromList = (currencyCode) => {
    for (let i = 0; i < this.state.CurrencyData.length; i++) {
      if (this.state.CurrencyData[i].currencyCode === currencyCode)
        return this.state.CurrencyData[i];
    }
  };
  ...
  selectDefaultCurrency = (currencyCode) => {
    if (currencyCode && this.state.CurrencyData.length) {
      const defCurrencyOption = this.state.CurrencyData.find(
        (currency) => currencyCode === currency.currencyCode
      );
      return {
        label: defCurrencyOption.currency,
        value: defCurrencyOption.currencyCode,
      };
    }
  };
  ...
  selectDefaultTimezone = (timezoneGuid) => {
    if (timezoneGuid && this.state.TimezoneData.length) {
      const defTimezoneOption = this.state.TimezoneData.find(
  ...
  selectDefaultcitizenshipId = (citizenshipId) => {
    if (citizenshipId && this.state.CitizenshipData.length) {
      const defCitizenshipOption = this.state.CitizenshipData.find(
  ...
  selectDefaultlanguageId = (languageId) => {
    if (languageId && this.state.WebSiteLanguageData.length) {
      const defLanguageOption = this.state.WebSiteLanguageData.find(
        ...
        this.setState({
          ...
          successTimer: setTimeout(() => {
            ...
            localStorage.setItem(
              ...
              this.state.ProfilePersonalInfo.profileImage
            );
          }, 2000),
        });
      } else
          ...
          <div className="my-profile-container d-flex flex-column align-items-center my-5">
            <div className="my-profile-photo d-flex justify-content-center align-items-center">
              <img
                ...
                src={ProfilePersonalInfo["profileImage"]}
                alt="profile"
              />
            </div>
            <div className="my-profile-info my-3">
              <div style={{ cursor: "pointer" }} onClick={this.togglePop}>
                {t("Doctor.Profile_Basic.Change_Profile_Picture")}
              </div>
            </div>
            {modal ? (
              <ProfileImgPopup
                profImg={
                  ProfilePersonalInfo["profileImageURL"] === null
                    ? ProfilePersonalInfo["profileImage"]
            ...
            <div className="my-profile-details">
              ...
              {changePasswordPopup ? (
                <ChangePasswordPopup
                  toggleChangePassword={this.togglechangePasswordPopup}
                />
              ) : null}
              <div className="my-phone my-3">
                <div
                  ...
                  style={{ cursor: "pointer" }}
                  onClick={this.toggleDeactivateAccountPopup.bind(this)}
                >
                  {t("Patient.PatientProfile.Delete_Account")}
                </div>
              </div>
              {deactivateAccountPopup ? (
                <DeactivateAccountPopup
                  user="Patient"
                  toggleDeactivateAccount={this.toggleDeactivateAccountPopup}
                />
              ) : null}
              {ProfilePersonalInfo["isMobileVerified"] === false && (
                <span>
                  ...
                  >
                    {t("Patient.PatientProfile.Send_OTP")}
                  </div>
                </span>
              )}
              {sendOTPPopup ? (
                <SendOTPPopup
                  ...
                  OTPMobileNo={ProfilePersonalInfo.phone}
                />
              ) : null}
            </div>
          </div>
          ...
          <div className="col-md-8 personal-info-right-content">
            ...
            <Formik
              ...
              initialValues={{
                ...
                socialSecurityNumber:
                  ProfilePersonalInfo.socialSecurityNumber || "",
            ...
            >
              {({ handleSubmit, errors, touched, handleChange }) => (
                <div className="divForm mt-4" onSubmit={handleSubmit}>
                  <div className="row">
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        ...
                        <label
                          data-domain="Not Verified"
                          className="patient-mobile-not-verify mobile-verify"
                        ></label>
                        <Field
                          type="text"
                          className={
                        ...
                        />
                        {errors.phone && touched.phone && (
                          <ErrorMessage error={errors.phone} t={t} />
                        )}
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        ...
                        <label
                          ...
                          className="patient-email-verify email-verify"
                        />
                        <Field
                          type="text"
                          disabled
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        ...
                        <div
                          className={`d-flex w-100 justify-content-between divForm-radio mt-1 ${
                            errors.gender &&
                            touched.gender &&
                            "error-message-input"
                          }`}
                        ...
                        {errors.gender && touched.gender && (
                          <ErrorMessage error={errors.gender} t={t} />
                        )}
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        ...
                        />
                        {errors.doB && touched.doB && (
                          <ErrorMessage error={errors.doB} t={t} />
                        )}
                      </div>
                    </div>
                  </div>
                  <div className="row">
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <div className="search-bar-text-input">
                                <label className="form-label">
                                  {t("Patient.PatientProfile.Weight")}
                                </label>
                                <Field
                                  type="text"
                                  className={
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              <div className="search-bar-text-input">
                                <label className="form-label">
                                  {t("Patient.PatientProfile.Height")}
                                </label>
                                <Field
                                  type="text"
                                  className={
                                ...
                                />
                                {errors.height && touched.height && (
                                  <ErrorMessage error={errors.height} t={t} />
                                )}
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        <label className="form-label">
                          {t("Patient.PatientProfile.Occupation")}
                        </label>
                        <Field
                          type="text"
                          className={
                        ...
                        />
                        {errors.occupation && touched.occupation && (
                          <ErrorMessage error={errors.occupation} t={t} />
                        )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        <div className="search-bar-text-input mb-4">
                          ...
                          {errors.languageId && touched.languageId && (
                            <ErrorMessage error={errors.languageId} t={t} />
                          )}
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="form-group">
                        <div className="search-bar-text-input mb-4">
                          ...
                          {errors.citizenshipId && touched.citizenshipId && (
                            <ErrorMessage error={errors.citizenshipId} t={t} />
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        <label className="form-label">
                          {t("Patient.PatientProfile.Timezone")}
                        </label>
                        <Select
                          name="timezoneGuid"
                          className={`${
                        ...
                        {errors.timezoneGuid && touched.timezoneGuid && (
                          <ErrorMessage error={errors.timezoneGuid} t={t} />
                        )}
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                      <div className="form-group">
                        <div className="search-bar-text-input mb-4">
                          <label className="form-label">
                            {t("Doctor.Profile_Basic.Social_Security_Number")}
                          </label>
                          <Field
                            type="text"
                            className={
                    ...
                    <div className="col-lg-6 col-md-12">
                      <div className="search-bar-text-input mb-4">
                        ...
                        {errors.currencyCode && touched.currencyCode && (
                          <ErrorMessage error={errors.currencyCode} t={t} />
                        )}
                      </div>
                    </div>
                  ...
                  <div className="w-100">
                    <div className="mb-5 d-flex justify-content-end">
                      <button
                        className="btn MyButton my-button-25 personal-info-button"
                        onClick={handleSubmit}
                        data-toggle="tab"
                        type="submit"
                      >
                        {t("Patient.PatientProfile.Save_Next")}
                      </button>
                    </div>
                  </div>
                </div>
...
const patientProfileSchema = object({
  ...
  socialSecurityNumber: string().required(
    "ProfileErrorMessages.socialsecurityNumber"
  ),
