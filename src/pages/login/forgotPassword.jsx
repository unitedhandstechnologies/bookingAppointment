...
class ForgotPassword extends React.Component {
  ...
  OnForgotPasswordSubmit() {
    if ($("#txtEmailId").val() === "") {
      ...
      promiseWrapper(this.props.actions.forgotPassword, {
    ...
    return (
      <div className="forget-password-section">
        <div className="divForm">
          <div className=" my-3">
            <img
              src="assets/images/Group7864.png"
              className="img-fluid forget-password-img"
              alt="Responsive img"
            />
          </div>
          <div className="forget-password-text">
            <p>
              {t("Enter_Email_Label1")} <br />
              {t("Enter_Email_Label2")}{" "}
            </p>
          </div>
          <div>
          ...
          <div className="mt-3">
            <ButtonComponent
              ID="btnSubmit"
              Action={this.OnForgotPasswordSubmit.bind(this)}
              ClassName="btn MyButton password-reset-button"
              Text={t("Submit")}
            />
          </div>
          <div className="mt-3">
            <a
              onClick={this.OnCancelForgotPassword.bind(this)}
              className="forgetPassword"
            >
              {" "}
              {t("ForgotPassword_Go_Back")}
            </a>{" "}
            {t("To_Login")}
          </div>
        </div>
