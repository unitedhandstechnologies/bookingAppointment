...
class HealthInformation extends React.Component {
  ...
  UpdateType1Answer = (questionGuid, e) => {
    let curState = this.state.AnswerDataList;
    let isExist = this.state.AnswerDataList.filter(
      (x) => x.questionGuid === questionGuid
    );
  ...
  changeStyle = (e) => {
    if (e.target.classList.contains("error-message-input"))
      e.target.classList.remove("error-message-input");
  };
          ...
          <div className="multi-step-form-container multi-step-form-container-progress-bar">
            <div className="multisteps-form ">
              <div className="multisteps-form__progress">
                <button
                  onClick={this.UpdateCurrentPage.bind(this, 1)}
                  className="multisteps-form__progress-btn js-active count1 count-align"
                  id="health-tracking-tab-btn"
                  type="button"
                  title="Health Tracking"
                >
                  <span className="multisteps-form__progress-text">
                    {t("Patient.HealthInformation.Health_Tracking")}
                  </span>
                </button>
                <button
                  onClick={this.UpdateCurrentPage.bind(this, 2)}
                  className="multisteps-form__progress-btn count2 count-align"
                  type="button"
                  id="hearing-and-seeing-tab-btn"
                  title="Hearing and Seeing"
                >
                  {t("Patient.HealthInformation.Hearing_Seeing")}
                </button>
                <button
                  onClick={this.UpdateCurrentPage.bind(this, 3)}
                  className="multisteps-form__progress-btn count3 count-align"
                  type="button"
                  id="digestion-nutrition-tab-btn"
                  title="Digestion and Nutrition"
                >
                  {t("Patient.HealthInformation.Digestion_Nutrition")}
                </button>
                <button
                  onClick={this.UpdateCurrentPage.bind(this, 4)}
                  className="multisteps-form__progress-btn count4 count-align"
                  type="button"
                  id="chronic-condition-tab-btn"
                  title="Chronic Diseasesand conditions"
                >
                  {t(
                    "Patient.HealthInformation.Chronic_Diseasesand_Conditions"
                  )}
                </button>
                <button
                  onClick={this.UpdateCurrentPage.bind(this, 5)}
                  className="multisteps-form__progress-btn count5 count-align"
                  type="button"
                  id="recent-history-tab-btn"
                  title="Recent Medical History (2 Months)"
                >
                  {t("Patient.HealthInformation.Recent_Medical_History")}
                </button>
                <button
                  onClick={this.UpdateCurrentPage.bind(this, 6)}
                  className="multisteps-form__progress-btn count6 count-align"
                  type="button"
                  id="medication-intake-tab-btn"
                  title="Medication Intake"
                >
                  {t("Patient.HealthInformation.Medication_Intake")}
                </button>
              </div>
                        ...
                        <div className="col-lg-6 col-md-12 patient-profile-input-container">
                          <div className="d-flex">
                                    ...
                                    .map((data, id4x) => (
                                      <div className="form-check" key={id4x}>
                                        <input
                                          ...
                                          checked={
                                            this.state.AnswerDataList.filter(
                                              (x) =>
                                                x.questionGuid ===
                                                d.questionGuid
                                            )[0] &&
                                          ...
                                          onChange={this.UpdateType4Answer.bind(
                                            this,
                                            d.questionGuid
                                          )}
                                        />
                            ...
                            {d.questionType === 2 && (
                              <>
                                <div className="">
                                  <div className="search-bar-text-input">
                                    <input
                                      ...
                                      id={`txtAns1-${d.questionGuid}`}
                                      className="form-control w-75"
                                      placeholder={d.placeholderText.slice(
                                        0,
                                        d.placeholderText.indexOf("|")
                                      )}
                                      onChange={(e) => this.changeStyle(e)}
                                    />
                                  </div>
                                ...
                                <div className="">
                                  <input
                                    type="text"
                                    id={`txtAns2-${d.questionGuid}`}
                                    className="form-control w-75"
                                    placeholder={d.placeholderText.slice(
                                      d.placeholderText.indexOf("|") + 1,
                                      d.placeholderText.length
                                    )}
                                    onChange={(e) => this.changeStyle(e)}
                                  />
                                </div>
                                  ...
                                  <div className="form-check">
                                    <div>
                                      <input
                                        ...
                                        onChange={this.UpdateType1Answer.bind(
                                          this,
                                          d.questionGuid
                                        )}
                                      />
                                      <label className="form-check-label">
                                        {t("Patient.HealthInformation.Yes")}
                                      </label>
                                    </div>
                                  </div>
                                  <div className="form-check">
                                    <div>
                                      ...
                                      />
                                      <label className="form-check-label">
                                        {t("Patient.HealthInformation.No")}
                                      </label>
                                    </div>
                                  </div>
                                  <div className="form-check">
                                    <div>
                                      ...
                                      <label className="form-check-label">
                                        {t(
                                          "Patient.HealthInformation.Don't_Know"
                                        )}
                                      </label>
                                    </div>
                                  </div>
                            ...
                            {d.displayAddButton === true && (
                              <div className="">
                                <button
                                  className="btn health-info-add-new-btn"
                                  onClick={this.AddNewAnswer.bind(
                                    this,
                                    d.questionGuid,
                                    d.questionType
                                  )}
                                  ...
                                  id="eye-btn"
                                >
                                  <span className="mx-2 fs-10">
                                    <i className="fas fa-plus"></i>
                                  </span>
                                  {t("Patient.HealthInformation.Add_New")}
                                </button>
                              </div>
                            )}
                          </div>
                      ...
                      <div className="diopters-dropdown my-4 position-relative">
                        {this.state.AnswerDataList.map((ad, idax) => (
                          <div className="px-2" key={idax}>
                            {ad.questionGuid === d.questionGuid &&
                              d.questionType === 3 && (
                                <div className="row my-2 health-info-div">
                                  ...
                                  <div className="col-md-6">
                                    <div className="row">
                                      ...
                                      <a
                                        onClick={this.RemoveAnswer.bind(
                                          this,
                                          idax
                                        )}
                                        className="text-danger mainLeftPanelFontSize25"
                                      >
                            ...
                            {ad.questionGuid === d.questionGuid &&
                              ...
                              ad.answer1 === "Yes" && (
                                <div className="search-bar-text-input">
                                  <textarea
                                    className="form-control textarea-remove-focus"
                                    id={`redioYesTxtAns-${d.questionGuid}`}
                                    rows="4"
                                    onChange={this.UpdateYesRadioText.bind(
                                      this,
                                      d.questionGuid
                                    )}
                                    placeholder={d.placeholderText}
                    ...
                    <div className="button-row mt-4 col-12 w-100">
                      {this.state.currentPage !== 1 && (
                        <button
                          ...
                          className="btn MyButton my-button-25 ml-auto me-4"
                          type="button"
                          title="Prev"
                        >
                          {t("Patient.HealthInformation.Prev")}
                        </button>
                      )}
                      {this.state.currentPage < 6 && (
                        <button
                          onClick={this._next.bind(this)}
                          className="btn MyButton my-button-25 ml-auto float-end"
                          type="button"
                          title="Next"
                        >
                          {t("Patient.HealthInformation.Next")}
                        </button>
                      )}
                      {this.state.currentPage == 6 && (
                        <button
                          ...
                          title="Save"
                        >
                          {t("Patient.HealthInformation.Save_Next")}
                        </button>
                      )}
                    </div>
                  </div>
...
export default connect(
  mapStoreToprops,
  mapDispatchToProps
)(withTranslation()(HealthInformation));
