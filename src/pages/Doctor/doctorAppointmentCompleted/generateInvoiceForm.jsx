...
export class GenerateInvoiceForm extends Component {
  ...
  getInvoiceDetails = () => {
    promiseWrapper(this.props.docactions.getInvoiceDetails, {
      ...
      .then((data) =>
        this.setState({
          ...
          socialSecurityNumber:
            data.data.socialSecurityNumber || "Not Provided",
        })
      )
  ...
  addAdditionalServiceData = (servicesArray, totalFee) =>
    this.setState({
      addedAdditionalServices: servicesArray,
      additionalFees: totalFee,
    });
  ...
  render() {
    ...
    const { generateInvoiceModal, t, setGenerateInvoiceModal } = this.props;
          ...
          <div className="modal-dialog mt-0 mb-0">
            <div className="modal-content">
              <div className="modal-header modify-modal-header">
                ...
                >
                  {t(
                    "Doctor.AppointmentCompleted.GenerateInvoiceForm.Generate_Invoice"
                  )}
                </h5>
                <button
                  type="button"
                ...
                >
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t(
                        "Doctor.AppointmentCompleted.GenerateInvoiceForm.Patient_Title"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t(
                        "Doctor.AppointmentCompleted.GenerateInvoiceForm.Patient_First_Name"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t(
                        "Doctor.AppointmentCompleted.GenerateInvoiceForm.Patient_Last_Name"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t(
                        "Doctor.AppointmentCompleted.GenerateInvoiceForm.Patient_Address"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group my-2">
                    <label className="mb-2">
                      {t(
                        "Doctor.AppointmentCompleted.GenerateInvoiceForm.Social_Security_Number"
                      )}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="my-2 d-flex justify-content-center mt-4">
                    ...
                    >
                      {t(
                        "Doctor.AppointmentCompleted.GenerateInvoiceForm.Submit"
                      )}
                    </button>
                  </div>
                </form>
