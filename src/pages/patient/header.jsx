        ...
        return (
            <>
                <div className="divLogo1 mobile-logo">
                    <Link to="/"><img src="assets/images/Group9488.png" className="img-fluid logo" alt="logo img" /></Link>
                </div>
                ...
                <div className=" moblie-searchbar">
                    <div className="nav-searchbar">
                        <div className="dropdown">
                            <button className="dropdown-toggle nav-dropdown-btn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="form-group search-doctor-group">
                            <input type="text" className="form-control search-doctor-input" id="exampleInputPassword1" placeholder="Search Dotors" />
                        </div>
                    ...
                    <div className="nav-bell">
                        <img src="assets/images/Group9152.png" alt="Group9152.png" className="img-fluid" />
                    </div>
                </div>
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(PatientHeader));