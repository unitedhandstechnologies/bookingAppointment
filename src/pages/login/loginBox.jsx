    ...
    return (
      <div className="login-tab">
          ...
          <li className="nav-item">
            ...
            >
              {localStorage.getItem("login-Type")
                ? localStorage.getItem("login-Type") === "Patient"
                  ? "User"
                  : localStorage.getItem("login-Type")
                : "User"}
              's {t("Login_Page.LoginBox.Login")}
            </a>
          </li>
          <li className="nav-item">
            <a
              ...
              aria-selected="false"
            >
              {t("Login_Page.LoginBox.Register")}
            </a>
          </li>
        </ul>
        <div className="tab-content login-section" id="pills-tabContent">
          ...
          >
            <LoginComponent
              onForgotPassword={this.LoadForgotPassword.bind(this)}
              onLoginNotVerified={this.LoadOTPBox.bind(this)}
            />
          </div>
          <div
          ...
          >
            <RegistrationComponent
              onRegistration={this.LoadOTPBox.bind(this)}
            />
          </div>
        </div>
      </div>
