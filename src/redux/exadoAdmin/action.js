import {
    GET_UNVERIFIED_DOCTORS_LIST, GET_DOCTOR_VIEW_DETAILS, VERIFY_DOCTOR_PROFILE,
    GET_PAGED_PATIENTS_LIST, GET_PAGED_DOCTORS_LIST, GET_PATIENT_VIEW_DETAILS,
...
const verifyDoctorProfile = ({ userGuid, verificationType, cancelReason, promise }) => (
    {
...
const exadoAdminActions = {
    getUnVerifiedDoctorsList, getDoctorViewDetails, verifyDoctorProfile, getPagedPatientsList,
    getPagedDoctorsList, getPatientViewDetails, getAllRefundData, approveRefund, getAllUnprocessedWithdraw, approveWithdraw, getAllReviews, deleteReviewById, getAllCommission, saveDoctorCommission, getFinanceData, markAsPaid, getDoctorPayment, saveCMSPage, getLanguageAllMessages, saveLanguageLabelData, getPatientQuestionnaireLanguage, savePatientQuestionnaireLanguage, getAllPhysicianServiceDetail, savePhysicianService, getAllLanguageDetail, saveLanguage, saveWebsiteLanguageId
};
