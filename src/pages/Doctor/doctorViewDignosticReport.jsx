                          ...
                          <div className="col-md-12 p-0">
                            <ul className="nav nav-pills nav-fill" id="myprofiletab" role="tablist">
                              <li className="nav-item">
                                <a className="nav-link active" id="about-patient-tab" data-toggle="tab" href="#about-patient" role="tab" aria-controls="about-patient" aria-selected="true">{t('Doctor.AboutPatient.About_patient')}</a>
                              </li>
                              <li className="nav-item">
                                <a className="nav-link" id="health-info-tab" data-toggle="tab" href="#patient-symptoms" role="tab" aria-controls="patient-symptoms" aria-selected="false">{t('Doctor.AboutPatient.Patient_Symptoms')}</a>
                              </li>
                              <li className="nav-item">
                                <a className="nav-link" id="patient-history-tab" data-toggle="tab" href="#patient-history" role="tab" aria-controls="patient-history" aria-selected="false">{t('Doctor.AboutPatient.Appointment_Details')}</a>
                              </li>
                            </ul>
                            <div className="tab-content" id="myTabContent">
                                  ...
                                  <div className="col-md-12">
                                    <div className="my-profile-container d-flex align-items-center">
                                      <div className="my-profile-photo d-flex justify-content-center align-items-center">
                                        <img src={this.state.DiagnosticDetails.patientData.profileImage} style={{ borderRadius: "50px" }} />
                                      </div>
                                      <div className="mx-4 my-profile-details">
                                        <div className="admin-name">
                                          <span>{this.state.DiagnosticDetails.patientData.firstName} {this.state.DiagnosticDetails.patientData.lastName}</span>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div className="row my-5">
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Gender-Age')}</span>
                                    </div>
                                  ...
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Date_of_Birth')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.doB === "" || this.state.DiagnosticDetails.patientData.doB == null ? "---" : this.state.DiagnosticDetails.patientData.doB}</span>
                                    </div>
                                  </div>
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Weight')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.weight === "" || this.state.DiagnosticDetails.patientData.weight == null ? "---" : this.state.DiagnosticDetails.patientData.weight + ' lbs'}</span>
                                    </div>
                                  </div>
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Height')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.height === "" || this.state.DiagnosticDetails.patientData.height == null ? "---" : this.state.DiagnosticDetails.patientData.height + ' ft'}</span>
                                    </div>
                                  </div>
                                </div>
                                <div className="row my-5">
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Mobile_Number')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.phone === "" || this.state.DiagnosticDetails.patientData.phone == null ? "---" : this.state.DiagnosticDetails.patientData.phone}</span>
                                    </div>
                                  </div>
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Email_Address')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.email}</span>
                                    </div>
                                  </div>
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Preferred_Language')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.preferredLanguages && this.state.DiagnosticDetails.patientData.preferredLanguages.length > 0 ? this.state.DiagnosticDetails.patientData.preferredLanguages.join(", ") : "---"}</span>
                                    </div>
                                  </div>
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Citizenship')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span className="mx-2">{this.state.DiagnosticDetails.patientData.country === "" || this.state.DiagnosticDetails.patientData.country == null ? "---" : this.state.DiagnosticDetails.patientData.country}</span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div className="tab-pane fade" id="patient-symptoms" role="tabpanel" aria-labelledby="health-info-tab">
                                <div className="patient-symptoms-container">
                                  <div className="my-4">
                                    <div className="patient-symptoms-question">
                                      {t('Doctor.ViewAppointmentPopup.Q_Since_when_the_symptoms_are_active_?_(4 hours_or_8_hours)')}
                                    </div>
                                    <div className="patient-symptoms-answer">
                                      <div className="d-flex">
                                        <span>{t('Doctor.ViewAppointmentPopup.A.')}</span>
                                  ...
                                  <div className="my-2">
                                    <div className="patient-symptoms-question">
                                      {t('Doctor.ViewAppointmentPopup.Q_Is_there_any_medication_or_any_treatment_taken_yet_?')}
                                    </div>
                                    <div className="patient-symptoms-answer">
                                      <div className="d-flex">
                                        <span>{t('Doctor.ViewAppointmentPopup.A.')}</span>
                                  ...
                                  <div className="my-2">
                                    <div className="patient-symptoms-question">
                                      {t('Doctor.ViewAppointmentPopup.Q_has_there_already_been_given_a_diagnosis_on_this_condition_?')}
                                    </div>
                                    <div className="patient-symptoms-answer">
                                      <div className="d-flex">
                                        <span>{t('Doctor.ViewAppointmentPopup.A.')}</span>
                              ...
                              <div className="tab-pane fade" id="patient-history" role="tabpanel" aria-labelledby="patient-history-tab">
                                  ...
                                  <div className="col-md-12 my-profile-column">
                                    <div className="my-profile-container d-flex align-items-center">
                                      ...
                                      <div className="mx-4 my-profile-details">
                                        ...
                                        <div className="my-profile-details-exp">{this.state.DiagnosticDetails.appointmentData.experience} {t('Doctor.AboutPatient.years_Experience_overall')}</div>
                                      </div>
                                    </div>
                                    {this.state.DiagnosticDetails.appointmentData.doctorGuid === localStorage.getItem("user-id") && (
                                      <>
                                        {this.state.DiagnosticDetails.appointmentData.isFeedbackGiven === false && this.state.DiagnosticDetails.appointmentData.feedbackPendingHours > 0 &&
                                          <div>
                                            <button className="btn doctor-dignostic-reprot-feedback-btn mt-3">{t('Doctor.AboutPatient.Feedback_pending')}</button>
                                          </div>
                                        }
                                        {this.state.DiagnosticDetails.appointmentData.isFeedbackGiven === false && this.state.DiagnosticDetails.appointmentData.feedbackPendingHours === 0 &&
                                          <div>
                                            <button className="btn btn-secondary mt-3" >{t('Doctor.AboutPatient.Feedback_expired')}</button>
                                          </div>
                                        }
                                        {this.state.DiagnosticDetails.appointmentData.isFeedbackGiven === true &&
                                          <div>
                                            <button className="btn btn-success mt-3">{t('Doctor.AboutPatient.Feedback_given')}</button>
                                          </div>
                                        }
                                      </>
                                    )}
                                ...
                                <div className="row mt-4">
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Date')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                  ...
                                  <div className="col-lg-2 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Time')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                  ...
                                  <div className="col-lg-2 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Patients_Details')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                  ...
                                  <div className="col-lg-3 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Booking_Id')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                  ...
                                  <div className="col-lg-2 col-md-6 col-12">
                                    <div className="admin-info-title">
                                      <span>{t('Doctor.AboutPatient.Consultation_Fees')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                ...
                                <div>
                                  <div className="doctor-report-title">
                                    <span className="doctor-report-title-text">{t('Doctor.AboutPatient.Diagnostic_Report')}</span>{
                                      this.state.DiagnosticDetails.appointmentData.doctorGuid === localStorage.getItem("user-id") &&
                                      <Link to={`/save-diagnostic/${this.props.match.params.appointmentGuid}`} className="btn doctor-report-edit-btn"><span><i className="fas fa-pen"></i></span> {t('Doctor.AboutPatient.Edit')}</Link>
                                    }
                                  </div>
                                  <div className="my-3">
                                    <div className="admin-info-title d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span>{t('Doctor.AboutPatient.Describe_problem_or_symptoms.')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                  ...
                                  <div className="mb-3">
                                    <div className="admin-info-title d-flex align-items-center">
                                      <div className="admin-desc-dot"></div>
                                      <span>{t('Doctor.AboutPatient.Diagnostic_Conclusion')}</span>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
                                  ...
                                  <div className="mb-3">
                                    <div>
                                      <div className="admin-info-title d-flex align-items-center">
                                        <div className="admin-desc-dot"></div>
                                        <span>{t('Doctor.AboutPatient.Prescribe_Medication')}</span>
                                      </div>
                                  ...
                                  {this.state.DiagnosticDetails.diagnosticReport.additionalDocuments && this.state.DiagnosticDetails.diagnosticReport.additionalDocuments.length > 0 &&
                                    <div className="mb-3">
                                      <div>
                                        <div className="admin-info-title d-flex align-items-center">
                                          <div className="admin-desc-dot"></div>
                                          <span>{t('Doctor.AboutPatient.Additional_Documents')}</span>
                                        </div>
                                ...
                                {this.state.DiagnosticDetails.review !== null &&
                                  <>
                                    ...
                                    <div className="doctor-details mt-4">
                                      <div className="admin-info-title d-flex align-items-center">
                                        <span className="admin-info-title-text">{t('Doctor.AboutPatient.Feedback')}</span>
                                      </div>
                                    </div>
                                    <div className="admin-info-description d-flex align-items-center">
...
export default connect(mapStoreToprops, mapDispatchToProps)(withTranslation()(DoctorViewDignosticReport));